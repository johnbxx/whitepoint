...
${s?s+`
`:""}  return v;
}`}zr();$n();Kt();hn();fl();Kt();Yh();var ji=xt,Ki=Rt($e.m.fromXyz,en),Zn=$e.m.fromXyz,E1=.206,Ou=.03,M1=(1+E1)/(1+Ou),zu=.017453292519943295,kM=216/24389,b1=24389/27,Bu=zt[0],i0=zt[1],T1=zt[2],VM=4*Bu/(Bu+15*i0+3*T1),GM=9*i0/(Bu+15*i0+3*T1),qr={js:{f:n=>Ls(n,"js"),decl:(n,e)=>`let ${n} = ${e};`,decl3:(n,e)=>`let ${n} = ${e};`,loop:(n,e)=>`for (let i = 0; i < ${n}; i++) {
${e}
...
fn wp_toe_inv(x: f32) -> f32 { return (x * x + ${n.k1} * x) / (${n.k3} * (x + ${n.k2})); }`}};function A1(n){return{a0:n.f(ji[0]),a1:n.f(ji[3]),a2:n.f(ji[6]),s0:n.f(Ki[0]),s1:n.f(Ki[1]),s2:n.f(Ki[2]),s3:n.f(Ki[3]),s4:n.f(Ki[4]),s5:n.f(Ki[5]),s6:n.f(Ki[6]),s7:n.f(Ki[7]),s8:n.f(Ki[8]),k1:n.f(E1),k2:n.f(Ou),k3:n.f(M1),k4k2k3:n.f(4*Ou*M1)}}function C1(n){return[n.decl("h",n.mod360(n.in(0))),n.decl("hr",`h * ${n.f(zu)}`),n.decl("ca",n.cos("hr")),n.decl("cb",n.sin("hr")),n.decl("kl",`${n.f(ji[1])} * ca + ${n.f(ji[2])} * cb`),n.decl("km",`${n.f(ji[4])} * ca + ${n.f(ji[5])} * cb`),n.decl("ks",`${n.f(ji[7])} * ca + ${n.f(ji[8])} * cb`)].join(`
  ...
  `)}function ku(n){return n.ret3("1.0","1.0","1.0")}function ea(n){return n.ret3("0.0","0.0","0.0")}function HM(n,e){let t=qr[n],i=`${Ds[n].srgb_encode}
...
${Gu[n]}`,r=(()=>{let a=si,c=rt(Mi.cat16);return[0,1,2].map(l=>t.f(c[3+l]/(a.rgbD[l]*a.fl)))})(),o=`  ${t.decl("tone",t.in(2))}
  if (tone <= 0.0) { ${ea(t)} }
  if (tone >= 100.0) { ${ku(t)} }
...
${Wu(ta("xyz-d65","oklch"),Hu("display-p3"),Hu("srgb"),ta("srgb","display-p3"))}
  void main() {
