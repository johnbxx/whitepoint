...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:hi,depthTest:!1,depthWrite:!1})}function hv(n,e,t){let i=new Float32Array(zs),s=new D(0,1,0);return new Ft({name:"SphericalGaussianBlur",defines:{n:zs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Xc(),fragmentShader:`
		...
		`,blending:hi,depthTest:!1,depthWrite:!1})}function Hf(){return new Ft({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xc(),fragmentShader:`
		...
		`,blending:hi,depthTest:!1,depthWrite:!1})}function $f(){return new Ft({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xc(),fragmentShader:`
	...
	`}var $c=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new no(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new rn(5,5,5),r=new Ft({name:"CubemapFromEquirect",uniforms:Bs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Qt,blending:hi});r.uniforms.tEquirect.value=t;let o=new ze(s,r),a=t.minFilter;return t.minFilter===us&&(t.minFilter=At),new ja(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,i=!0,s=!0){let r=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,i,s);e.setRenderTarget(r)}};function uv(n){let e=new WeakMap,t=new WeakMap,i=null;function s(u,d=!1){return u==null?null:d?o(u):r(u)}function r(u){if(u&&u.isTexture){let d=u.mapping;if(d===ec||d===tc)if(e.has(u)){let g=e.get(u).texture;return a(g,u.mapping)}else{let g=u.image;if(g&&g.height>0){let v=new $c(g.height);return v.fromEquirectangularTexture(n,u),e.set(u,v),u.addEventListener("dispose",l),a(v.texture,u.mapping)}else return null}}return u}function o(u){if(u&&u.isTexture){let d=u.mapping,g=d===ec||d===tc,v=d===hs||d===Os;if(g||v){let m=t.get(u),p=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==p)return i===null&&(i=new Hc(n)),m=g?i.fromEquirectangular(u,m):i.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{let M=u.image;return g&&M&&M.height>0||v&&M&&c(M)?(i===null&&(i=new Hc(n)),m=g?i.fromEquirectangular(u):i.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",h),m.texture):null}}}return u}function a(u,d){return d===ec?u.mapping=hs:d===tc&&(u.mapping=Os),u}function c(u){let d=0,g=6;for(let v=0;v<g;v++)u[v]!==void 0&&d++;return d===g}function l(u){let d=u.target;d.removeEventListener("dispose",l);let g=e.get(d);g!==void 0&&(e.delete(d),g.dispose())}function h(u){let d=u.target;d.removeEventListener("dispose",h);let g=t.get(d);g!==void 0&&(t.delete(d),g.dispose())}function f(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function fv(n){let e={};function t(i){if(e[i]!==void 0)return e[i];let s=n.getExtension(i);return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){let s=t(i);return s===null&&Ta("WebGLRenderer: "+i+" extension not supported."),s}}}function dv(n,e,t,i){let s={},r=new WeakMap;function o(f){let u=f.target;u.index!==null&&e.remove(u.index);for(let g in u.attributes)e.remove(u.attributes[g]);u.removeEventListener("dispose",o),delete s[u.id];let d=r.get(u);d&&(e.remove(d),r.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function a(f,u){return s[u.id]===!0||(u.addEventListener("dispose",o),s[u.id]=!0,t.memory.geometries++),u}function c(f){let u=f.attributes;for(let d in u)e.update(u[d],n.ARRAY_BUFFER)}function l(f){let u=[],d=f.index,g=f.attributes.position,v=0;if(g===void 0)return;if(d!==null){let M=d.array;v=d.version;for(let w=0,b=M.length;w<b;w+=3){let A=M[w+0],E=M[w+1],P=M[w+2];u.push(A,E,E,P,P,A)}}else{let M=g.array;v=g.version;for(let w=0,b=M.length/3-1;w<b;w+=3){let A=w+0,E=w+1,P=w+2;u.push(A,E,E,P,P,A)}}let m=new(g.count>=65535?jr:Kr)(u,1);m.version=v;let p=r.get(f);p&&e.remove(p),r.set(f,m)}function h(f){let u=r.get(f);if(u){let d=f.index;d!==null&&u.version<d.version&&l(f)}else l(f);return r.get(f)}return{get:a,update:c,getWireframeAttribute:h}}function pv(n,e,t){let i;function s(f){i=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function c(f,u){n.drawElements(i,u,r,f*o),t.update(u,i,1)}function l(f,u,d){d!==0&&(n.drawElementsInstanced(i,u,r,f*o,d),t.update(u,i,d))}function h(f,u,d){if(d===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,u,0,r,f,0,d);let v=0;for(let m=0;m<d;m++)v+=u[m];t.update(v,i,1)}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h}function mv(n){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(r/3);break;case n.LINES:t.lines+=a*(r/2);break;case n.LINE_STRIP:t.lines+=a*(r-1);break;case n.LINE_LOOP:t.lines+=a*r;break;case n.POINTS:t.points+=a*r;break;default:Te("WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function gv(n,e,t){let i=new WeakMap,s=new yt;function r(o,a,c){let l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=h!==void 0?h.length:0,u=i.get(a);if(u===void 0||u.count!==f){let T=function(){P.dispose(),i.delete(a),a.removeEventListener("dispose",T)};u!==void 0&&u.texture.dispose();let d=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,v=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],M=a.morphAttributes.color||[],w=0;d===!0&&(w=1),g===!0&&(w=2),v===!0&&(w=3);let b=a.attributes.position.count*w,A=1;b>e.maxTextureSize&&(A=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);let E=new Float32Array(b*A*4*f),P=new Jr(E,b,A,f);P.type=Zn,P.needsUpdate=!0;let x=w*4;for(let L=0;L<f;L++){let C=m[L],R=p[L],k=M[L],G=b*A*4*L;for(let N=0;N<C.count;N++){let B=N*x;d===!0&&(s.fromBufferAttribute(C,N),E[G+B+0]=s.x,E[G+B+1]=s.y,E[G+B+2]=s.z,E[G+B+3]=0),g===!0&&(s.fromBufferAttribute(R,N),E[G+B+4]=s.x,E[G+B+5]=s.y,E[G+B+6]=s.z,E[G+B+7]=0),v===!0&&(s.fromBufferAttribute(k,N),E[G+B+8]=s.x,E[G+B+9]=s.y,E[G+B+10]=s.z,E[G+B+11]=k.itemSize===4?s.w:1)}}u={count:f,texture:P,size:new we(b,A)},i.set(a,u),a.addEventListener("dispose",T)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let d=0;for(let v=0;v<l.length;v++)d+=l[v];let g=a.morphTargetsRelative?1:1-d;c.getUniforms().setValue(n,"morphTargetBaseInfluence",g),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",u.size)}return{update:r}}function _v(n,e,t,i,s){let r=new WeakMap;function o(l){let h=s.render.frame,f=l.geometry,u=e.get(l,f);if(r.get(u)!==h&&(e.update(u),r.set(u,h)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==h&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,h))),l.isSkinnedMesh){let d=l.skeleton;r.get(d)!==h&&(d.update(),r.set(d,h))}return u}function a(){r=new WeakMap}function c(l){let h=l.target;h.removeEventListener("dispose",c),i.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:o,dispose:a}}var xv={[D0]:"LINEAR_TONE_MAPPING",[N0]:"REINHARD_TONE_MAPPING",[U0]:"CINEON_TONE_MAPPING",[F0]:"ACES_FILMIC_TONE_MAPPING",[B0]:"AGX_TONE_MAPPING",[z0]:"NEUTRAL_TONE_MAPPING",[O0]:"CUSTOM_TONE_MAPPING"};function vv(n,e,t,i,s){let r=new Xt(e,t,{type:n,depthBuffer:i,stencilBuffer:s,depthTexture:i?new Ei(e,t):void 0}),o=new Xt(e,t,{type:Sn,depthBuffer:!1,stencilBuffer:!1}),a=new jt;a.setAttribute("position",new Et([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Et([0,2,0,0,2,0],2));let c=new fr({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new ze(a,c),h=new Fs(-1,1,1,-1,0,1),f=null,u=null,d=!1,g,v=null,m=[],p=!1;this.setSize=function(M,w){r.setSize(M,w),o.setSize(M,w);for(let b=0;b<m.length;b++){let A=m[b];A.setSize&&A.setSize(M,w)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;let w=r.width,b=r.height;for(let A=0;A<m.length;A++){let E=m[A];E.setSize&&E.setSize(w,b)}},this.begin=function(M,w){if(d||M.toneMapping===Mn&&m.length===0)return!1;if(v=w,w!==null){let b=w.width,A=w.height;(r.width!==b||r.height!==A)&&this.setSize(b,A)}return p===!1&&M.setRenderTarget(r),g=M.toneMapping,M.toneMapping=Mn,!0},this.hasRenderPass=function(){return p},this.end=function(M,w){M.toneMapping=g,d=!0;let b=r,A=o;for(let E=0;E<m.length;E++){let P=m[E];if(P.enabled!==!1&&(P.render(M,A,b,w),P.needsSwap!==!1)){let x=b;b=A,A=x}}if(f!==M.outputColorSpace||u!==M.toneMapping){f=M.outputColorSpace,u=M.toneMapping,c.defines={},Be.getTransfer(f)===Ze&&(c.defines.SRGB_TRANSFER="");let E=xv[u];E&&(c.defines[E]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=b.texture,M.setRenderTarget(v),M.render(l,h),v=null,d=!1},this.isCompositing=function(){return d},this.dispose=function(){r.depthTexture&&r.depthTexture.dispose(),r.dispose(),o.dispose(),a.dispose(),c.dispose()}}var hd=new sn,ah=new Ei(1,1),ud=new Jr,fd=new Pa,dd=new no,Wf=[],Xf=[],qf=new Float32Array(16),Yf=new Float32Array(9),Zf=new Float32Array(4);function vr(n,e,t){let i=n[0];if(i<=0||i>0)return n;let s=e*t,r=Wf[s];if(r===void 0&&(r=new Float32Array(s),Wf[s]=r),e!==0){i.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(r,a)}return r}function It(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Lt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function qc(n,e){let t=Xf[e];t===void 0&&(t=new Int32Array(e),Xf[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function yv(n,e){let t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Mv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;n.uniform2fv(this.addr,e),Lt(t,e)}}function bv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(It(t,e))return;n.uniform3fv(this.addr,e),Lt(t,e)}}function Sv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;n.uniform4fv(this.addr,e),Lt(t,e)}}function wv(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(It(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Lt(t,e)}else{if(It(t,i))return;Zf.set(i),n.uniformMatrix2fv(this.addr,!1,Zf),Lt(t,i)}}function Ev(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(It(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Lt(t,e)}else{if(It(t,i))return;Yf.set(i),n.uniformMatrix3fv(this.addr,!1,Yf),Lt(t,i)}}function Tv(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(It(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Lt(t,e)}else{if(It(t,i))return;qf.set(i),n.uniformMatrix4fv(this.addr,!1,qf),Lt(t,i)}}function Av(n,e){let t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Cv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;n.uniform2iv(this.addr,e),Lt(t,e)}}function Rv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;n.uniform3iv(this.addr,e),Lt(t,e)}}function Pv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;n.uniform4iv(this.addr,e),Lt(t,e)}}function Iv(n,e){let t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Lv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;n.uniform2uiv(this.addr,e),Lt(t,e)}}function Dv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;n.uniform3uiv(this.addr,e),Lt(t,e)}}function Nv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;n.uniform4uiv(this.addr,e),Lt(t,e)}}function Uv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(ah.compareFunction=t.isReversedDepthBuffer()?kc:zc,r=ah):r=hd,t.setTexture2D(e||r,s)}function Fv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||fd,s)}function Ov(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||dd,s)}function Bv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||ud,s)}function zv(n){switch(n){case 5126:return yv;case 35664:return Mv;case 35665:return bv;case 35666:return Sv;case 35674:return wv;case 35675:return Ev;case 35676:return Tv;case 5124:case 35670:return Av;case 35667:case 35671:return Cv;case 35668:case 35672:return Rv;case 35669:case 35673:return Pv;case 5125:return Iv;case 36294:return Lv;case 36295:return Dv;case 36296:return Nv;case 35678:case 36198:case 36298:case 36306:case 35682:return Uv;case 35679:case 36299:case 36307:return Fv;case 35680:case 36300:case 36308:case 36293:return Ov;case 36289:case 36303:case 36311:case 36292:return Bv}}function kv(n,e){n.uniform1fv(this.addr,e)}function Vv(n,e){let t=vr(e,this.size,2);n.uniform2fv(this.addr,t)}function Gv(n,e){let t=vr(e,this.size,3);n.uniform3fv(this.addr,t)}function Hv(n,e){let t=vr(e,this.size,4);n.uniform4fv(this.addr,t)}function $v(n,e){let t=vr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Wv(n,e){let t=vr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Xv(n,e){let t=vr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function qv(n,e){n.uniform1iv(this.addr,e)}function Yv(n,e){n.uniform2iv(this.addr,e)}function Zv(n,e){n.uniform3iv(this.addr,e)}function Jv(n,e){n.uniform4iv(this.addr,e)}function Kv(n,e){n.uniform1uiv(this.addr,e)}function jv(n,e){n.uniform2uiv(this.addr,e)}function Qv(n,e){n.uniform3uiv(this.addr,e)}function e2(n,e){n.uniform4uiv(this.addr,e)}function t2(n,e,t){let i=this.cache,s=e.length,r=qc(t,s);It(i,r)||(n.uniform1iv(this.addr,r),Lt(i,r));let o;this.type===n.SAMPLER_2D_SHADOW?o=ah:o=hd;for(let a=0;a!==s;++a)t.setTexture2D(e[a]||o,r[a])}function n2(n,e,t){let i=this.cache,s=e.length,r=qc(t,s);It(i,r)||(n.uniform1iv(this.addr,r),Lt(i,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||fd,r[o])}function i2(n,e,t){let i=this.cache,s=e.length,r=qc(t,s);It(i,r)||(n.uniform1iv(this.addr,r),Lt(i,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||dd,r[o])}function s2(n,e,t){let i=this.cache,s=e.length,r=qc(t,s);It(i,r)||(n.uniform1iv(this.addr,r),Lt(i,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||ud,r[o])}function r2(n){switch(n){case 5126:return kv;case 35664:return Vv;case 35665:return Gv;case 35666:return Hv;case 35674:return $v;case 35675:return Wv;case 35676:return Xv;case 5124:case 35670:return qv;case 35667:case 35671:return Yv;case 35668:case 35672:return Zv;case 35669:case 35673:return Jv;case 5125:return Kv;case 36294:return jv;case 36295:return Qv;case 36296:return e2;case 35678:case 36198:case 36298:case 36306:case 35682:return t2;case 35679:case 36299:case 36307:return n2;case 35680:case 36300:case 36308:case 36293:return i2;case 36289:case 36303:case 36311:case 36292:return s2}}var ch=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=zv(t.type)}},lh=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=r2(t.type)}},hh=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){let s=this.seq;for(let r=0,o=s.length;r!==o;++r){let a=s[r];a.setValue(e,t[a.id],i)}}},rh=/(\w+)(\])?(\[|\.)?/g;function Jf(n,e){n.seq.push(e),n.map[e.id]=e}function o2(n,e,t){let i=n.name,s=i.length;for(rh.lastIndex=0;;){let r=rh.exec(i),o=rh.lastIndex,a=r[1],c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Jf(t,l===void 0?new ch(a,n,e):new lh(a,n,e));break}else{let f=t.map[a];f===void 0&&(f=new hh(a),Jf(t,f)),t=f}}}var xr=class{constructor(e,t){this.seq=[],this.map={};let i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){let a=e.getActiveUniform(t,o),c=e.getUniformLocation(t,a.name);o2(a,c,this)}let s=[],r=[];for(let o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,i,s){let r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){let s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,o=t.length;r!==o;++r){let a=t[r],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,t){let i=[];for(let s=0,r=e.length;s!==r;++s){let o=e[s];o.id in t&&i.push(o)}return i}};function Kf(n,e,t){let i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}var a2=37297,c2=0;function l2(n,e){let t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){let a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}var jf=new Pe;function h2(n){Be._getMatrix(jf,Be.workingColorSpace,n);let e=`mat3( ${jf.elements.map(t=>t.toFixed(4))} )`;switch(Be.getTransfer(n)){case qr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return Ee("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Qf(n,e,t){let i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+l2(n.getShaderSource(e),a)}else return r}function u2(n,e){let t=h2(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}var f2={[D0]:"Linear",[N0]:"Reinhard",[U0]:"Cineon",[F0]:"ACESFilmic",[B0]:"AgX",[z0]:"Neutral",[O0]:"Custom"};function d2(n,e){let t=f2[e];return t===void 0?(Ee("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Gc=new D;function p2(){Be.getLuminanceCoefficients(Gc);let n=Gc.x.toFixed(4),e=Gc.y.toFixed(4),t=Gc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function m2(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(To).join(`
`)}function g2(n){let e=[];for(let t in n){let i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function _2(n,e){let t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(e,s),o=r.name,a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function To(n){return n!==""}function ed(n,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function td(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var x2=/^[ \t]*#include +<([\w\d./]+)>/gm;function uh(n){return n.replace(x2,y2)}var v2=new Map;function y2(n,e){let t=Fe[e];if(t===void 0){let i=v2.get(e);if(i!==void 0)t=Fe[i],Ee('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return uh(t)}var M2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function nd(n){return n.replace(M2,b2)}function b2(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function id(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}var S2={[fo]:"SHADOWMAP_TYPE_PCF",[dr]:"SHADOWMAP_TYPE_VSM"};function w2(n){return S2[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var E2={[hs]:"ENVMAP_TYPE_CUBE",[Os]:"ENVMAP_TYPE_CUBE",[po]:"ENVMAP_TYPE_CUBE_UV"};function T2(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":E2[n.envMapMode]||"ENVMAP_TYPE_CUBE"}var A2={[Os]:"ENVMAP_MODE_REFRACTION"};function C2(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":A2[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}var R2={[L0]:"ENVMAP_BLENDING_MULTIPLY",[bf]:"ENVMAP_BLENDING_MIX",[Sf]:"ENVMAP_BLENDING_ADD"};function P2(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":R2[n.combine]||"ENVMAP_BLENDING_NONE"}function I2(n){let e=n.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function L2(n,e,t,i){let s=n.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,c=w2(t),l=T2(t),h=C2(t),f=P2(t),u=I2(t),d=m2(t),g=g2(r),v=s.createProgram(),m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);let w=M+m+o,b=M+p+a,A=Kf(s,s.VERTEX_SHADER,w),E=Kf(s,s.FRAGMENT_SHADER,b);s.attachShader(v,A),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function P(C){if(n.debug.checkShaderErrors){let R=s.getProgramInfoLog(v)||"",k=s.getShaderInfoLog(A)||"",G=s.getShaderInfoLog(E)||"",N=R.trim(),B=k.trim(),H=G.trim(),j=!0,Q=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(j=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,A,E);else{let le=Qf(s,A,"vertex"),xe=Qf(s,E,"fragment");Te("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
${s?s+`
`:""}  return v;
}`}var Xi=_t,Wi=Ct($e.m.fromXyz,Kt),Gn=$e.m.fromXyz,Fm=.206,au=.03,Lm=(1+Fm)/(1+au),lu=.017453292519943295,Jy=216/24389,Dm=24389/27,cu=Ot[0],Ol=Ot[1],Om=Ot[2],Ky=4*cu/(cu+15*Ol+3*Om),jy=9*Ol/(cu+15*Ol+3*Om),Dr={js:{f:n=>Ss(n,"js"),decl:(n,e)=>`let ${n} = ${e};`,decl3:(n,e)=>`let ${n} = ${e};`,loop:(n,e)=>`for (let i = 0; i < ${n}; i++) {
${e}
...
fn wp_toe_inv(x: f32) -> f32 { return (x * x + ${n.k1} * x) / (${n.k3} * (x + ${n.k2})); }`}};function Bm(n){return{a0:n.f(Xi[0]),a1:n.f(Xi[3]),a2:n.f(Xi[6]),s0:n.f(Wi[0]),s1:n.f(Wi[1]),s2:n.f(Wi[2]),s3:n.f(Wi[3]),s4:n.f(Wi[4]),s5:n.f(Wi[5]),s6:n.f(Wi[6]),s7:n.f(Wi[7]),s8:n.f(Wi[8]),k1:n.f(Fm),k2:n.f(au),k3:n.f(Lm),k4k2k3:n.f(4*au*Lm)}}function zm(n){return[n.decl("h",n.mod360(n.in(0))),n.decl("hr",`h * ${n.f(lu)}`),n.decl("ca",n.cos("hr")),n.decl("cb",n.sin("hr")),n.decl("kl",`${n.f(Xi[1])} * ca + ${n.f(Xi[2])} * cb`),n.decl("km",`${n.f(Xi[4])} * ca + ${n.f(Xi[5])} * cb`),n.decl("ks",`${n.f(Xi[7])} * ca + ${n.f(Xi[8])} * cb`)].join(`
  ...
  `)}function hu(n){return n.ret3("1.0","1.0","1.0")}function Vo(n){return n.ret3("0.0","0.0","0.0")}function Qy(n,e){let t=Dr[n],i=`${ws[n].srgb_encode}
...
`),a=`  ${i.decl("s",i.in(1))}
  ...
  ${i.decl("sub2","sub1")}
  if (sub1 <= ${i.f(Jy)}) { sub2 = ll / ${i.f(Dm)}; }
  ${i.decl("mx","1e30")}
${o}
  ${i.decl("C","mx / 100.0 * s")}
  ${i.decl("uu","C * chh")}
  ${i.decl("vv","C * sh")}
  ${i.decl("up",`uu / (13.0 * ll) + ${i.f(Ky)}`)}
  ${i.decl("vp",`vv / (13.0 * ll) + ${i.f(jy)}`)}
  ${i.decl("Y",`ll / ${i.f(Dm)}`)}
...
fn wp_cam_unadapt(v: f32) -> f32 { let a = abs(v); let base = max(0.0, 27.13 * a / (400.0 - a)); return sign(v) * pow(base, ${(1/.42).toPrecision(17)}); }`};function Gm(n,e){return`${n.decl("alpha",`C / ${n.sqrt("J / 100.0")}`)}
  ...
  ${n.decl("lb",`${e.Mb[6]} * cr + ${e.Mb[7]} * cg + ${e.Mb[8]} * cbn`)}`}function tM(n,e){let t=Dr[n],i=uu(t),s=`${ws[n].srgb_decode}
${fu[n]}`,r=`  ${t.decl("dr",`wp_srgb_decode(${t.in(0)})`)}
  ...
  ${t.ret3("1.7 * J / (1.0 + 0.007 * J)",`Mp * ${t.cos("hr")}`,`Mp * ${t.sin("hr")}`)}`;return t.wrap(e,s,r)}function nM(n,e){let t=Dr[n],i=uu(t),s=`${ws[n].srgb_encode}
${fu[n]}`,r=`  ${t.decl("Jp",t.in(0))}
  ...
  ${t.decl("eHue",`0.25 * (${t.cos("hr + 2.0")} + 3.8)`)}
  ${Gm(t,i)}
  ${t.ret3("wp_srgb_encode(lr)","wp_srgb_encode(lg)","wp_srgb_encode(lb)")}`;return t.wrap(e,s,r)}function iM(n,e){let t=Dr[n],i=uu(t),s=`${ws[n].srgb_encode}
${fu[n]}`,r=(()=>{let a=Kn,c=st(pi.cat16);return[0,1,2].map(l=>t.f(c[3+l]/(a.rgbD[l]*a.fl)))})(),o=`  ${t.decl("tone",t.in(2))}
  ...
  ${Gm(t,i)}
  ${t.ret3("wp_srgb_encode(lr)","wp_srgb_encode(lg)","wp_srgb_encode(lb)")}`;return t.wrap(e,s,o)}var sM={"okhsv|srgb":Qy,"okhsl|srgb":eM,"hsluv|srgb":(n,e)=>Um(n,e,!1),"hpluv|srgb":(n,e)=>Um(n,e,!0),"srgb|cam16-ucs":tM,"cam16-ucs|srgb":nM,"hct|srgb":iM};function Hm(n,e,t,i){let s=sM[`${e}|${t}`];return s?s(n,i):null}function Wm(n,e){let t=$i[n],i=$i[e];if(!t)throw new Error(`codegen: unsupported space "${n}" (have: ${Object.keys($i).join(", ")})`);if(!i)throw new Error(`codegen: unsupported space "${e}"`);return Im([...t.toXyzOps,...i.fromXyzOps])}function Xm(n,e){return`wp_${n}_to_${e}`.replace(/-/g,"_")}function Go(n,e,{name:t=Xm(n,e)}={}){return Hm("glsl",n,e,t)??ou(Wm(n,e),t,"glsl")}function rM(n){return`wp_gamut_map_oklch_to_${n}`.replace(/-/g,"_")}function oM(n,e,t){let i=Xm("oklch",e),s=ou(Wm("oklch",e),i,n);return n==="js"?`${s}
...
}`}function aM(n){let e=$i[n];if(!e||!e.fromXyzOps.some(t=>t.k==="mat3"))throw new Error(`codegen: gamut mapping needs an RGB gamut space (got "${n}")`)}function du(n,{name:e=rM(n)}={}){return aM(n),oM("glsl",n,e)}var cM={hsl:0,hwb:0,hsv:0,hsi:0,okhsl:0,okhsv:0,hct:0,hsluv:0,hpluv:0,lch:2,oklch:2,lchuv:2,jzczhz:2,"din99o-lch":2,cam16:2},lM=["shorter","longer","increasing","decreasing"];function $m(n,e){let i=`${(n==="glsl"||n==="wgsl"?(s,r)=>`mod(${s}, ${r})`:(s,r)=>`(((${s}) % ${r}) + ${r}) % ${r}`)("hb - ha + 360.0","360.0")}`;switch(e){case"shorter":return`float d0 = ${i}; float d = d0 > 180.0 ? d0 - 360.0 : d0;`;case"longer":return`float d0 = ${i}; float d = d0 == 0.0 ? 360.0 : (d0 < 180.0 ? d0 - 360.0 : d0);`;case"increasing":return`float d = ${i};`;case"decreasing":return`float d0 = ${i}; float d = d0 == 0.0 ? 0.0 : d0 - 360.0;`;default:throw new Error(`codegen: unknown hue method "${e}"`)}}function hM(n,e,t,i){let s=cM[e]??-1;if(!$i[e]&&s===-1)throw new Error(`codegen: unsupported space "${e}"`);if(!lM.includes(t))throw new Error(`codegen: unknown hue method "${t}"`);let r=["x","y","z"],o=l=>`a.${r[l]} + t * (b.${r[l]} - a.${r[l]})`;if(n==="js"){let l=[];for(let h=0;h<3;h++)h===s?l.push(`  const ha = ((a[${h}] % 360) + 360) % 360;`,`  const hb = ((b[${h}] % 360) + 360) % 360;`,`  ${$m("js",t).replace(/float /g,"const ").replace(/const d0/,"const d0").replace("const d =","const d =")}`,`  out[${h}] = (((ha + t * d) % 360) + 360) % 360;`):l.push(`  out[${h}] = a[${h}] + t * (b[${h}] - a[${h}]);`);return`function ${i}(a, b, t, out = [0, 0, 0]) {
${l.join(`
`)}
  return out;
  ...
  v.${r[s]} = (ha + t * d) % 360.0;
  return v;
}`}function uM(n,e){return`wp_mix_${n}_${e}`.replace(/-/g,"_")}function qm(n,{hue:e="shorter",name:t=uM(n,e)}={}){return hM("glsl",n,e,t)}function Bl(n,e,t,i=24,s=0,r=Math.PI*2){let o=[];for(let a=0;a<=i;a++){let c=s+(r-s)*(a/i);o.push([n+t*Math.cos(c),e+t*Math.sin(c)])}return o}var qi=(n,e,t,i,s,r=10)=>Bl(n,e,t,r,i*Math.PI/180,s*Math.PI/180),fM={w:{w:.84,strokes:[[[0,1],[.22,0],[.42,.75],[.62,0],[.84,1]]]},h:{w:.6,strokes:[[[0,1.5],[0,0]],[[0,.55],...qi(.3,.55,.3,180,0),[.6,0]]]},i:{w:.06,strokes:[[[0,1],[0,0]],Bl(0,1.28,.045,10)],closed:[!1,!0]},t:{w:.6,strokes:[[[.3,1.45],[.3,.2],...qi(.5,.2,.2,180,270)],[[0,1],[.6,1]]]},e:{w:.9,strokes:[[[.07,.55],[.83,.55],...qi(.45,.5,.45,7,320,26)]]},p:{w:.85,strokes:[[[0,1],[0,-.5]],[[0,.78],...qi(.38,.5,.45,128,-128),[0,.22]]]},o:{w:.9,strokes:[Bl(.45,.5,.45)],closed:[!0]},n:{w:.56,strokes:[[[0,1],[0,0]],[[0,.58],...qi(.28,.58,.28,180,0),[.56,0]]]},B:{w:.85,strokes:[[[0,1.4],[0,0]],[[0,1.4],[.45,1.4],...qi(.45,1.05,.35,90,-90),[0,.7],[.5,.7],...qi(.5,.35,.35,90,-90),[0,0]]]},A:{w:.9,strokes:[[[0,0],[.45,1.4],[.9,0]],[[.2,.5],[.7,.5]]]},R:{w:.8,strokes:[[[0,1.4],[0,0]],[[0,1.4],[.4,1.4],...qi(.4,1.05,.35,90,-90),[0,.7]],[[.3,.7],[.75,0]]]},O:{w:.95,strokes:[dM(.475,.7,.42,.7)],closed:[!0]},P:{w:.8,strokes:[[[0,1.4],[0,0]],[[0,1.4],[.4,1.4],...qi(.4,1.05,.35,90,-90),[0,.7]]]},E:{w:.75,strokes:[[[.72,1.4],[0,1.4],[0,0],[.72,0]],[[0,.7],[.58,.7]]]},N:{w:.8,strokes:[[[0,0],[0,1.4],[.75,0],[.75,1.4]]]},L:{w:.72,strokes:[[[0,1.4],[0,0],[.68,0]]]},I:{w:.06,strokes:[[[0,1.4],[0,0]]]},V:{w:.9,strokes:[[[0,1.4],[.45,0],[.9,1.4]]]}};function dM(n,e,t,i,s=28){let r=[];for(let o=0;o<=s;o++){let a=Math.PI*2*o/s;r.push([n+t*Math.cos(a),e+i*Math.sin(a)])}return r}var Ym={w:1.5,strokes:[[[-.7,1.55],[0,.7],[.7,1.55]],[[0,.66],[0,.08]],[[-.34,.04],[.34,.04]],Bl(.16,1.22,.1,14),[[.16,1.34],[.4,1.66]]],closed:[!1,!1,!1,!0,!1]};function pM(n,e=.05){if(n.length<3)return n;let t=[n[0]];for(let i=1;i<n.length-1;i++){let[s,r]=n[i-1],[o,a]=n[i],[c,l]=n[i+1],h=[s-o,r-a],f=[c-o,l-a],u=Math.hypot(...h),d=Math.hypot(...f),g=Math.min(e,u*.4,d*.4);if(g<1e-4){t.push(n[i]);continue}let v=[o+h[0]/u*g,a+h[1]/u*g],m=[o+f[0]/d*g,a+f[1]/d*g];for(let p=0;p<=1;p+=.25){let M=1-p;t.push([M*M*v[0]+2*M*p*o+p*p*m[0],M*M*v[1]+2*M*p*a+p*p*m[1]])}}return t.push(n[n.length-1]),t}function mM(n,{radius:e=.035,closed:t=!1}={}){let i=n.filter(([c,l],h)=>h===0||Math.hypot(c-n[h-1][0],l-n[h-1][1])>1e-4),r=(t?i:pM(i)).map(([c,l])=>new D(c,l,0));t&&r.pop();let o=new ur(r,t,"catmullrom",t?.5:0),a=Math.max(12,r.length*4);return new co(o,a,e,8,t)}function Zm(n,{radius:e=.035,spacing:t=.32}={}){let i=[],s=0,r=typeof n=="string"?[...n].map(o=>fM[o]):n;for(let o of r){if(!o){s+=.5;continue}o.strokes.forEach((a,c)=>{let l=mM(a.map(([h,f])=>[h+s,f]),{radius:e,closed:o.closed?.[c]??!1});i.push(l)}),s+=o.w+t}return{geometries:i,width:Math.max(0,s-t)}}function mu(...n){let e=new Set,t=[];for(let i of n){let s=i.split(`
...
${mu(Go("xyz-d65","oklch"),du("display-p3"),du("srgb"),Go("srgb","display-p3"))}
  void main() {
...
`;function pu(n,e){let t=new fr({glslVersion:bo,vertexShader:gM,fragmentShader:n,uniforms:e,depthTest:!1,depthWrite:!1}),i=new ze(new jt,t);i.frustumCulled=!1,i.geometry.setDrawRange(0,3);let r=new Ns;return r.add(i),{scene:r,mat:t}}function Jm(n,e){return new Xt(n,e,{type:Sn,minFilter:At,magFilter:At,depthBuffer:!1,colorSpace:On})}function gu(n,e,t,i){let s=new Xt(e,t,{type:Sn,samples:4,colorSpace:On}),r=Math.max(1,e>>1),o=Math.max(1,t>>1),a=Jm(r,o),c=Jm(r,o),l=pu(xM,{tScene:{value:s.texture},uMode:i,uThreshold:{value:1.2}}),h=pu(vM,{tSrc:{value:null},uDir:{value:new we}}),f=pu(_M(),{tScene:{value:s.texture},tBloom:{value:c.texture},uMode:i,uP3:{value:0},uSrgbPreview:{value:0},uExposure:{value:1},uBloomAmt:{value:.7}}),u=new Fs;function d(v,m){n.setRenderTarget(s),n.render(v,m),n.setRenderTarget(a),n.render(l.scene,u);for(let p=0;p<2;p++)h.mat.uniforms.tSrc.value=a.texture,h.mat.uniforms.uDir.value.set(1/r,0),n.setRenderTarget(c),n.render(h.scene,u),h.mat.uniforms.tSrc.value=c.texture,h.mat.uniforms.uDir.value.set(0,1/o),n.setRenderTarget(a),n.render(h.scene,u);f.mat.uniforms.tBloom.value=a.texture,n.setRenderTarget(null),n.render(f.scene,u)}function g(){s.dispose(),a.dispose(),c.dispose();for(let v of[l,h,f])v.mat.dispose()}return{render:d,output:f.mat,sceneRT:s,dispose:g}}var Pn=8,yM=`
  varying vec3 vPos;
  varying vec3 vNormal;
  varying vec2 vUv;
  void main() {
...
`}function ti(n){return new D(n[0],n[1],n[2])}function zl(n,e){let t=n.slice(0,Pn).map(ti);for(;t.length<Pn;)t.push(ti(e));return t}function tn(n,e,t=e,i={}){let{pairs:s}=n.derived,r=new Ft({vertexShader:yM,fragmentShader:MM,uniforms:{uPairA:{value:zl(s[e],[0,0,0])},uPairB:{value:zl(s[t],[0,0,0])},uNaiveLight:n.shared.uNaiveLight,uLightPos:n.shared.uLightPos,uIntensity:n.shared.uIntensity,uAlbedoA:{value:ti(n.materialsSrgb[e])},uAlbedoB:{value:ti(n.materialsSrgb[t])},uUvScale:{value:new we(...i.uvScale??[1,1])},uKind:{value:i.kind??0},uWetness:n.shared.uWetness,uMode:n.uMode}});return n.surfaceMats.push({mat:r,matA:e,matB:t}),r}function t1(n){for(let e of n.tubeMats??[])e.uniforms.uXyz.value.set(...n.xyz),e.uniforms.uNaive.value.set(...n.naive);if(n.haloMat){let{bright:e,dark:t}=n1(n);n.haloMat.uniforms.uLchBright.value.set(...e),n.haloMat.uniforms.uLchDark.value.set(...t),n.haloMat.uniforms.uNaive.value.set(...n.naive.map(i=>i*.5))}}function _u(n){let{pairs:e,lights:t}=n.derived;for(let{mat:i,matA:s,matB:r}of n.surfaceMats)i.uniforms.uPairA.value=zl(e[s],[0,0,0]),i.uniforms.uPairB.value=zl(e[r],[0,0,0]);t.forEach((i,s)=>{s<Pn&&n.shared.uNaiveLight.value[s].set(...i.naive)})}function wM(n,e,t){return new Ft({vertexShader:bM,fragmentShader:jm,uniforms:{uXyz:{value:ti(e.xyz)},uNaive:{value:ti(e.naive)},uPower:{value:t},uFlicker:e.flicker,uMode:n.uMode}})}function xu(n,e,t,i,{grad:s=0,flicker:r}={}){return new Ft({vertexShader:e1,fragmentShader:Qm,uniforms:{uXyz:{value:ti(e)},uNaive:{value:ti(t)},uPower:{value:i},uFlicker:r??{value:1},uGrad:{value:s},uMode:n.uMode}})}function n1(n){let e=Qn(n.xyz.map(i=>i*.32),"xyz-d65","oklch"),t=[.045,Math.min(e[1]*.35,.04),e[2]];return{bright:e,dark:t}}function EM(n,e,t){let{bright:i,dark:s}=n1(e);return new Ft({vertexShader:e1,fragmentShader:SM(),uniforms:{uLchBright:{value:ti(i)},uLchDark:{value:ti(s)},uNaive:{value:ti(e.naive.map(r=>r*.5))},uPower:{value:t},uFlicker:e.flicker,uMode:n.uMode},transparent:!0,blending:pr,depthWrite:!1})}function Km(n,e,{scale:t,tubeR:i=.035,panelPad:s=.3,haloScale:r=2.6,power:o=14}){let a=new xn,{geometries:c,width:l}=Zm(e.text,{radius:i/t}),h=wM(n,e,o);e.tubeMats=[h];let f=new xn;for(let m of c){let p=new ze(m,h);p.userData.light=e,n.clickables.push(p),f.add(p)}f.scale.setScalar(t),f.position.set(-l/2*t,-.5*t,.1),a.add(f);let u=l*t+s*2,d=1.5*t+s*2,g=new ze(new rn(u,d,.06),tn(n,"panel"));g.position.set(0,.25*t,.02),g.userData.light=e,n.clickables.push(g),a.add(g);let v=new ze(new on(u*r,d*r),EM(n,e,.3));if(e.haloMat=v.material,v.position.set(0,.25*t,.075),a.add(v),e.facing==="front")a.position.set(e.pos[0],e.pos[1],e.pos[2]);else{let m=e.pos[0]<0?-1:1;a.rotation.y=m<0?Math.PI/2:-Math.PI/2,a.position.set(e.pos[0]*.97,e.pos[1],e.pos[2])}return a}function TM(n,e,t){let i=new xn,s=1,r=1.5,o=new ze(new rn(s+.16,r+.16,.1),tn(n,"panel"));i.add(o);let a=2,c=3,l=s/a,h=r/c;e.paneMats=[];for(let u=0;u<c;u++)for(let d=0;d<a;d++){let g=t[(u*a+d)%t.length],v=xu(n,g.xyz,g.naive,1.1,{flicker:e.flicker});e.paneMats.push(v);let m=new ze(new on(l-.05,h-.05),v);m.position.set((d+.5)*l-s/2,(u+.5)*h-r/2,.06),i.add(m)}let f=e.pos[0]<0?-1:1;return i.rotation.y=f<0?Math.PI/2:-Math.PI/2,i.position.set(e.pos[0]*.97,e.pos[1],e.pos[2]),i}function AM(n,e){let t=new xn,i=tn(n,"metal"),s=new ze(new Ti(.05,.07,4.7,10),i);s.position.set(2.45,2.35,e.pos[2]),t.add(s);let r=new ze(new Ti(.04,.04,1.3,8),i);r.rotation.z=Math.PI/2,r.position.set(1.85,4.66,e.pos[2]),t.add(r);let o=new ze(new so(.24,.22,12),i);o.position.set(e.pos[0],e.pos[1]+.16,e.pos[2]),t.add(o);let a=new ze(new ao(.13,16,12),xu(n,e.xyz,e.naive,9,{flicker:e.flicker}));return e.headMat=a.material,a.position.set(...e.pos),t.add(a),t}function CM(n,e){let t=new xn;for(let i of e)i.updateMatrixWorld(!0),i.traverse(s=>{if(!s.isMesh)return;let r=s.material.fragmentShader===jm,o=s.material.fragmentShader===Qm;if(!r&&!o)return;let a=s.material.clone();a.uniforms.uFlicker=s.material.uniforms.uFlicker,a.uniforms.uMode=n.uMode,a.uniforms.uPower={value:s.material.uniforms.uPower.value},n.reflectionMats.push({m:a,src:s.material}),a.transparent=!0,a.blending=pr,a.depthWrite=!1,a.side=Un;let c=new ze(s.geometry,a);c.applyMatrix4(s.matrixWorld),c.applyMatrix4(new at().makeScale(1,-1,1)),c.applyMatrix4(new at().makeScale(1,1.18,1)),t.add(c)});return t}function i1(n){let e=n.shared.uWetness.value;for(let{m:t,src:i}of n.reflectionMats)t.uniforms.uPower.value=i.uniforms.uPower.value*.38*e,t.uniforms.uXyz=i.uniforms.uXyz,t.uniforms.uNaive=i.uniforms.uNaive}function s1(n){let e=new Ns,{lights:t,windowPanes:i,sky:s,skyNaive:r}=n.derived,o=Object.fromEntries(t.map(P=>[P.name,P])),a=new ze(new on(7.2,26,1,1),tn(n,"asphalt","asphaltWet",{kind:2,uvScale:[6,22]}));a.rotation.x=-Math.PI/2,a.position.set(0,0,-5),a.material.depthWrite=!1,a.renderOrder=-2,e.add(a);let c={kind:1,uvScale:[104,84]},l=new ze(new on(21,7),tn(n,"brick","mortar",{kind:1,uvScale:[84,84]}));l.rotation.y=Math.PI/2,l.position.set(-2.8,3.5,-2.5),e.add(l);let h=new ze(new on(26,7),tn(n,"brick","mortar",c));h.rotation.y=-Math.PI/2,h.position.set(2.8,3.5,-5),e.add(h);let f=new ze(new on(4.1,5.2),tn(n,"brick","mortar",{kind:1,uvScale:[16,62]}));f.position.set(-.75,2.6,-13),e.add(f);let u=new ze(new on(1.7,5.2),tn(n,"concrete","concrete",{kind:1,uvScale:[6,38]}));u.position.set(1.95,2.6,-18),e.add(u);let d=new ze(new on(9,7),xu(n,s,r,3,{grad:1}));d.position.set(0,8.4,-18.4),e.add(d);for(let P of[-2.65,2.65]){let x=new ze(new rn(.3,.16,26),tn(n,"concrete"));x.position.set(P,.08,-5),e.add(x)}let g=[],v=(P,x)=>{let T=Km(n,P,x);g.push(T),e.add(T)};o.whitepoint.text="whitepoint";let m=Km(n,o.whitepoint,{scale:.45,power:5.5});g.push(m),e.add(m);for(let P of[-1,1]){let x=new ze(new Ti(.012,.012,2.6,6),tn(n,"metal"));x.position.set(.45+P*2.1,5.45,-5.2),x.rotation.z=P*.45,e.add(x)}o.bar.text="BAR",v(o.bar,{scale:.42,tubeR:.04,power:4.5}),o.open.text="OPEN",v(o.open,{scale:.3,power:4.5}),o.cocktail.text=[Ym],v(o.cocktail,{scale:.62,power:4.5}),o.live.text="LIVE",v(o.live,{scale:.34,power:4.2});let p=TM(n,o.window,i);e.add(p);let M=AM(n,o.street);e.add(M);let w=new ze(new rn(.06,2.2,1),tn(n,"door"));w.position.set(-2.76,1.1,-2.2),e.add(w);let b=new ze(new rn(.5,.14,1.2),tn(n,"concrete"));b.position.set(-2.6,.07,-2.2),e.add(b);let A=new ze(new rn(.95,1.15,1.9),tn(n,"door"));A.position.set(-2.25,.58,-7.6),e.add(A);let E=new ze(new rn(1,.08,1.95),tn(n,"metal"));E.position.set(-2.27,1.18,-7.6),E.rotation.z=.07,e.add(E);for(let[P,x]of[[-6.2,6.8],[-11.5,6.8]]){let T=new ze(new Ti(.05,.05,x,8),tn(n,"metal"));T.position.set(2.74,x/2,P),e.add(T)}return e.add(CM(n,[...g,p,M])),e}Be.enabled=!1;var PM=[{name:"whitepoint",gas:"neon",pos:[.45,4.15,-5.2],facing:"front",nudge:[0,-.6,.7],intensity:1.6},{name:"bar",gas:"helium",pos:[-2.05,3.05,-1.6],facing:"front",nudge:[0,0,.5],intensity:1},{name:"open",gas:"mercury",pos:[2,2.75,-7.5],facing:"front",nudge:[0,0,.5],intensity:.9},{name:"cocktail",gas:"xenon",pos:[-1.75,3.15,-12.9],facing:"front",nudge:[0,0,.6],intensity:.85},{name:"live",gas:"hydrogen",pos:[-.35,2.35,-12.9],facing:"front",nudge:[0,0,.6],intensity:.7},{name:"window",window:["#1a3f8f","#8f1a2e","#1f6e52","#b1741f"],pos:[-2.8,2.6,-10.5],intensity:.6},{name:"street",gas:"sodium-lamp",pos:[1.25,4.55,4.6],intensity:2.2}],IM=n=>{if(n.nudge)return n.pos.map((t,i)=>t+n.nudge[i]);let e=Math.abs(n.pos[0])>2.5?-Math.sign(n.pos[0])*.5:0;return[n.pos[0]+e,n.pos[1],n.pos[2]]},Fr=document.getElementById("alley"),Ho=Fr.getContext("webgl2",{antialias:!1,alpha:!1,preserveDrawingBuffer:!0});if("drawingBufferColorSpace"in Ho)try{Ho.drawingBufferColorSpace="display-p3"}catch{}var Hl=Ho.drawingBufferColorSpace==="display-p3",$o=new Wc({canvas:Fr,context:Ho,antialias:!1});$o.toneMapping=Mn;var Hn=Mm(PM);Hn.lights.forEach(n=>{n.flicker={value:1}});var vu=(n,e)=>Array.from({length:n},(t,i)=>e(i)),g1={uLightPos:{value:vu(Pn,n=>new D(...Hn.lights[n]?IM(Hn.lights[n]):[0,-99,0]))},uIntensity:{value:vu(Pn,n=>Hn.lights[n]?.intensity??0)},uNaiveLight:{value:vu(Pn,n=>new D(...Hn.lights[n]?.naive??[0,0,0]))},uWetness:{value:.85}},$l={value:0},Or={derived:Hn,materialsSrgb:Fl,shared:g1,uMode:$l,surfaceMats:[],reflectionMats:[],clickables:[]};Hn.lights.forEach((n,e)=>{n.index=e});var LM=s1(Or),Ur=new Wt(54,1,.1,80);function _1(){let n=Fr.clientWidth,e=Math.round(n*.58),t=Math.min(window.devicePixelRatio||1,2);return $o.setSize(n,e,!1),$o.setPixelRatio(t),Ur.aspect=n/e,Ur.updateProjectionMatrix(),[Math.round(n*t),Math.round(e*t)]}var[Vl,Gl]=_1(),Es=gu($o,Vl,Gl,$l);Es.output.uniforms.uP3.value=Hl?1:0;window.addEventListener("resize",()=>{let[n,e]=_1();(n!==Vl||e!==Gl)&&([Vl,Gl]=[n,e],Es.dispose?.(),Es=gu($o,Vl,Gl,$l),Es.output.uniforms.uP3.value=Hl?1:0,Es.output.uniforms.uSrgbPreview.value=fn.srgbPreview?1:0)});var fn={naive:!1,sodiumOnly:!1,srgbPreview:!1},a1=document.getElementById("mode");a1?.addEventListener("change",()=>{fn.naive=a1.checked,$l.value=fn.naive?1:0,document.body.dataset.mode=fn.naive?"naive":"whitepoint"});var c1=document.getElementById("gamut-badge");c1&&(c1.textContent=Hl?"display-p3 output \u2014 your display shows the wide-gamut reds":"sRGB display \u2014 the emitted cusp mapper is doing the fallback live");var l1=document.getElementById("derived");function Mu(){l1&&(l1.textContent=Hn.lights.map(n=>{let[e,t,i]=n.xyz,s=e/(e+t+i),r=t/(e+t+i),o=n.window?"2700 K Planck \xD7 stained glass":n.gas==="sodium-lamp"?"Na D doublet":`${n.gas} (NIST lines)`;return`${n.name.padEnd(10)} ${o.padEnd(28)} xy ${s.toFixed(3)} ${r.toFixed(3)}   naive #${n.naive.map(a=>Math.round(a*255).toString(16).padStart(2,"0")).join("")}`}).join(`
`))}Mu();var bu=Hn.lights.filter(n=>n.gas&&n.gas!=="sodium-lamp"),Nr=bu[0],h1=document.getElementById("sign-tabs"),u1=document.getElementById("gas-row"),f1=document.getElementById("gas-info");function d1(n,e,t,i=""){let s=document.createElement("button");return s.className=`chip ${e?"on":""} ${i}`,s.textContent=n,s.addEventListener("click",t),s}function Wl(){!h1||!u1||(h1.replaceChildren(...bu.map(n=>d1(n.name,n===Nr,()=>{Nr=n,Wl()}))),u1.replaceChildren(...Object.keys(Ul).map(n=>d1(n,Nr.gas===n,()=>DM(Nr,n)))),f1&&(f1.textContent=Ul[Nr.gas]??""))}function DM(n,e){Jh(Hn,n.index,e),_u(Or),t1(n),Mu(),Wl()}Wl();var p1=new uo;Fr.addEventListener("click",n=>{let e=Fr.getBoundingClientRect(),t=new we((n.clientX-e.left)/e.width*2-1,-((n.clientY-e.top)/e.height)*2+1);p1.setFromCamera(t,Ur);let i=p1.intersectObjects(Or.clickables,!1)[0];i?.object.userData.light&&bu.includes(i.object.userData.light)&&(Nr=i.object.userData.light,Wl())});var yu=document.getElementById("kill");yu?.addEventListener("click",()=>{fn.sodiumOnly=!fn.sodiumOnly,yu.classList.toggle("on",fn.sodiumOnly),yu.textContent=fn.sodiumOnly?"relight the neon":"kill the neon"});var kl=document.getElementById("srgb-preview");kl&&Hl&&(kl.hidden=!1,kl.addEventListener("click",()=>{fn.srgbPreview=!fn.srgbPreview,kl.classList.toggle("on",fn.srgbPreview),Es.output.uniforms.uSrgbPreview.value=fn.srgbPreview?1:0}));var NM=n=>n-Math.floor(n),m1=n=>NM(Math.sin(n*12.9898)*43758.5453);function UM(n,e,t){let i=1+.022*Math.sin(e*120*Math.PI+n*1.7),s=Math.floor(e*6.3)+n*197,a=m1(s)<(t?.14:.035)?.3+.55*m1(s+.5):1;return i*a}function x1(n){Ur.position.set(.26*Math.sin(n*.07),1.7+.05*Math.sin(n*.11),7.4),Ur.lookAt(.1*Math.sin(n*.05),2.15,-6),Hn.lights.forEach((e,t)=>{let i=e.gas==="sodium-lamp",s=fn.sodiumOnly&&!i?0:1,r=UM(t,n,e.name==="live")*s;e.flicker.value=r,g1.uIntensity.value[t]=e.intensity*r}),i1(Or),Es.render(LM,Ur)}var FM=performance.now();function v1(){x1((performance.now()-FM)/1e3),requestAnimationFrame(v1)}requestAnimationFrame(v1);window.__alley={ctx:Or,swapGas:(n,e)=>{Jh(Hn,n,e),_u(Or),Mu()},state:fn,GASES:Ul,tick:x1,gl:Ho,post:()=>Es};location.search.includes("selftest")&&Promise.resolve().then(()=>(o1(),r1)).then(n=>n.selftest(window.__alley,Fr));
