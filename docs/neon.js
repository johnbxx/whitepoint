...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gi,depthTest:!1,depthWrite:!1})}function e2(n,e,t){let i=new Float32Array(Zs),s=new D(0,1,0);return new Lt({name:"SphericalGaussianBlur",defines:{n:Zs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:sl(),fragmentShader:`
		...
		`,blending:gi,depthTest:!1,depthWrite:!1})}function yd(){return new Lt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sl(),fragmentShader:`
		...
		`,blending:gi,depthTest:!1,depthWrite:!1})}function Md(){return new Lt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sl(),fragmentShader:`
	...
	`}var nl=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new go(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var n3={[oh]:"Linear",[ah]:"Reinhard",[ch]:"Cineon",[lh]:"ACESFilmic",[uh]:"AgX",[fh]:"Neutral",[hh]:"Custom"};function i3(n,e){let t=n3[e];return t===void 0?(Ee("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var el=new D;function s3(){ze.getLuminanceCoefficients(el);let n=el.x.toFixed(4),e=el.y.toFixed(4),t=el.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let w=M+m+o,b=M+p+a,A=Cd(s,s.VERTEX_SHADER,w),E=Cd(s,s.FRAGMENT_SHADER,b);s.attachShader(v,A),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function P(C){if(n.debug.checkShaderErrors){let R=s.getProgramInfoLog(v)||"",V=s.getShaderInfoLog(A)||"",G=s.getShaderInfoLog(E)||"",U=R.trim(),z=V.trim(),$=G.trim(),j=!0,Q=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(j=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,A,E);else{let le=Pd(s,A,"vertex"),xe=Pd(s,E,"fragment");Te("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
${s?s+`
`:""}  return v;
}`}zr();$n();Kt();hn();cl();Kt();Yh();var ji=xt,Ki=Rt($e.m.fromXyz,en),Zn=$e.m.fromXyz,E1=.206,Ou=.03,M1=(1+E1)/(1+Ou),zu=.017453292519943295,kM=216/24389,b1=24389/27,Bu=zt[0],i0=zt[1],T1=zt[2],VM=4*Bu/(Bu+15*i0+3*T1),GM=9*i0/(Bu+15*i0+3*T1),qr={js:{f:n=>Ls(n,"js"),decl:(n,e)=>`let ${n} = ${e};`,decl3:(n,e)=>`let ${n} = ${e};`,loop:(n,e)=>`for (let i = 0; i < ${n}; i++) {
${e}
...
fn wp_toe_inv(x: f32) -> f32 { return (x * x + ${n.k1} * x) / (${n.k3} * (x + ${n.k2})); }`}};function A1(n){return{a0:n.f(ji[0]),a1:n.f(ji[3]),a2:n.f(ji[6]),s0:n.f(Ki[0]),s1:n.f(Ki[1]),s2:n.f(Ki[2]),s3:n.f(Ki[3]),s4:n.f(Ki[4]),s5:n.f(Ki[5]),s6:n.f(Ki[6]),s7:n.f(Ki[7]),s8:n.f(Ki[8]),k1:n.f(E1),k2:n.f(Ou),k3:n.f(M1),k4k2k3:n.f(4*Ou*M1)}}function C1(n){return[n.decl("h",n.mod360(n.in(0))),n.decl("hr",`h * ${n.f(zu)}`),n.decl("ca",n.cos("hr")),n.decl("cb",n.sin("hr")),n.decl("kl",`${n.f(ji[1])} * ca + ${n.f(ji[2])} * cb`),n.decl("km",`${n.f(ji[4])} * ca + ${n.f(ji[5])} * cb`),n.decl("ks",`${n.f(ji[7])} * ca + ${n.f(ji[8])} * cb`)].join(`
  ...
  `)}function ku(n){return n.ret3("1.0","1.0","1.0")}function Qo(n){return n.ret3("0.0","0.0","0.0")}function HM(n,e){let t=qr[n],i=`${Ds[n].srgb_encode}
...
${Gu[n]}`,r=`  ${t.decl("dr",`wp_srgb_decode(${t.in(0)})`)}
...
${Gu[n]}`,r=(()=>{let a=si,c=rt(yi.cat16);return[0,1,2].map(l=>t.f(c[3+l]/(a.rgbD[l]*a.fl)))})(),o=`  ${t.decl("tone",t.in(2))}
  if (tone <= 0.0) { ${Qo(t)} }
  if (tone >= 100.0) { ${ku(t)} }
  ...
  ${I1(t,i)}
  ${t.ret3("wp_srgb_encode(lr)","wp_srgb_encode(lg)","wp_srgb_encode(lb)")}`;return t.wrap(e,s,o)}var YM={"okhsv|srgb":HM,"okhsl|srgb":$M,"hsluv|srgb":(n,e)=>w1(n,e,!1),"hpluv|srgb":(n,e)=>w1(n,e,!0),"srgb|cam16-ucs":WM,"cam16-ucs|srgb":XM,"hct|srgb":qM};function L1(n,e,t,i){let s=YM[`${e}|${t}`];return s?s(n,i):null}function N1(n,e){let t=Ji[n],i=Ji[e];if(!t)throw new Error(`codegen: unsupported space "${n}" (have: ${Object.keys(Ji).join(", ")})`);if(!i)throw new Error(`codegen: unsupported space "${e}"`);return y1([...t.toXyzOps,...i.fromXyzOps])}function U1(n,e){return`wp_${n}_to_${e}`.replace(/-/g,"_")}function ea(n,e,{name:t=U1(n,e)}={}){return L1("glsl",n,e,t)??Fu(N1(n,e),t,"glsl")}function ZM(n){return`wp_gamut_map_oklch_to_${n}`.replace(/-/g,"_")}function JM(n,e,t){let i=U1("oklch",e),s=Fu(N1("oklch",e),i,n);return n==="js"?`${s}
...
${Wu(ea("xyz-d65","oklch"),Hu("display-p3"),Hu("srgb"),ea("srgb","display-p3"))}
  void main() {
