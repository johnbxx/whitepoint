...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function yv(n,e,t){let i=new Float32Array(Hs),s=new D(0,1,0);return new It({name:"SphericalGaussianBlur",defines:{n:Hs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function Jf(){return new It({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function Kf(){return new It({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
	...
	`}var Xc=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new ro(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Fe(a,c),h=new zs(-1,1,1,-1,0,1),f=null,u=null,d=!1,g,v=null,m=[],p=!1;this.setSize=function(M,w){r.setSize(M,w),o.setSize(M,w);for(let b=0;b<m.length;b++){let A=m[b];A.setSize&&A.setSize(M,w)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;let w=r.width,b=r.height;for(let A=0;A<m.length;A++){let E=m[A];E.setSize&&E.setSize(w,b)}},this.begin=function(M,w){if(d||M.toneMapping===bn&&m.length===0)return!1;if(v=w,w!==null){let b=w.width,A=w.height;(r.width!==b||r.height!==A)&&this.setSize(b,A)}return p===!1&&M.setRenderTarget(r),g=M.toneMapping,M.toneMapping=bn,!0},this.hasRenderPass=function(){return p},this.end=function(M,w){M.toneMapping=g,d=!0;let b=r,A=o;for(let E=0;E<m.length;E++){let P=m[E];if(P.enabled!==!1&&(P.render(M,A,b,w),P.needsSwap!==!1)){let x=b;b=A,A=x}}if(f!==M.outputColorSpace||u!==M.toneMapping){f=M.outputColorSpace,u=M.toneMapping,c.defines={},ze.getTransfer(f)===Ze&&(c.defines.SRGB_TRANSFER="");let E=Cv[u];E&&(c.defines[E]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=b.texture,M.setRenderTarget(v),M.render(l,h),v=null,d=!1},this.isCompositing=function(){return d},this.dispose=function(){r.depthTexture&&r.depthTexture.dispose(),r.dispose(),o.dispose(),a.dispose(),c.dispose()}}var _d=new rn,xh=new Ti(1,1),xd=new Qr,vd=new La,yd=new ro,jf=[],Qf=[],ed=new Float32Array(16),td=new Float32Array(9),nd=new Float32Array(4);function Sr(n,e,t){let i=n[0];if(i<=0||i>0)return n;let s=e*t,r=jf[s];if(r===void 0&&(r=new Float32Array(s),jf[s]=r),e!==0){i.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(r,a)}return r}function Lt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Dt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Zc(n,e){let t=Qf[e];t===void 0&&(t=new Int32Array(e),Qf[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Pv(n,e){let t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Iv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2fv(this.addr,e),Dt(t,e)}}function Lv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;n.uniform3fv(this.addr,e),Dt(t,e)}}function Dv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4fv(this.addr,e),Dt(t,e)}}function Nv(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;nd.set(i),n.uniformMatrix2fv(this.addr,!1,nd),Dt(t,i)}}function Uv(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;td.set(i),n.uniformMatrix3fv(this.addr,!1,td),Dt(t,i)}}function Fv(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;ed.set(i),n.uniformMatrix4fv(this.addr,!1,ed),Dt(t,i)}}function Ov(n,e){let t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Bv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2iv(this.addr,e),Dt(t,e)}}function zv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3iv(this.addr,e),Dt(t,e)}}function kv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4iv(this.addr,e),Dt(t,e)}}function Vv(n,e){let t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Gv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2uiv(this.addr,e),Dt(t,e)}}function Hv(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3uiv(this.addr,e),Dt(t,e)}}function $v(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4uiv(this.addr,e),Dt(t,e)}}function Wv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(xh.compareFunction=t.isReversedDepthBuffer()?Gc:Vc,r=xh):r=_d,t.setTexture2D(e||r,s)}function Xv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||vd,s)}function qv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||yd,s)}function Yv(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||xd,s)}function Zv(n){switch(n){case 5126:return Pv;case 35664:return Iv;case 35665:return Lv;case 35666:return Dv;case 35674:return Nv;case 35675:return Uv;case 35676:return Fv;case 5124:case 35670:return Ov;case 35667:case 35671:return Bv;case 35668:case 35672:return zv;case 35669:case 35673:return kv;case 5125:return Vv;case 36294:return Gv;case 36295:return Hv;case 36296:return $v;case 35678:case 36198:case 36298:case 36306:case 35682:return Wv;case 35679:case 36299:case 36307:return Xv;case 35680:case 36300:case 36308:case 36293:return qv;case 36289:case 36303:case 36311:case 36292:return Yv}}function Jv(n,e){n.uniform1fv(this.addr,e)}function Kv(n,e){let t=Sr(e,this.size,2);n.uniform2fv(this.addr,t)}function jv(n,e){let t=Sr(e,this.size,3);n.uniform3fv(this.addr,t)}function Qv(n,e){let t=Sr(e,this.size,4);n.uniform4fv(this.addr,t)}function e2(n,e){let t=Sr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function t2(n,e){let t=Sr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function n2(n,e){let t=Sr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function i2(n,e){n.uniform1iv(this.addr,e)}function s2(n,e){n.uniform2iv(this.addr,e)}function r2(n,e){n.uniform3iv(this.addr,e)}function o2(n,e){n.uniform4iv(this.addr,e)}function a2(n,e){n.uniform1uiv(this.addr,e)}function c2(n,e){n.uniform2uiv(this.addr,e)}function l2(n,e){n.uniform3uiv(this.addr,e)}function h2(n,e){n.uniform4uiv(this.addr,e)}function u2(n,e,t){let i=this.cache,s=e.length,r=Zc(t,s);Lt(i,r)||(n.uniform1iv(this.addr,r),Dt(i,r));let o;this.type===n.SAMPLER_2D_SHADOW?o=xh:o=_d;for(let a=0;a!==s;++a)t.setTexture2D(e[a]||o,r[a])}function f2(n,e,t){let i=this.cache,s=e.length,r=Zc(t,s);Lt(i,r)||(n.uniform1iv(this.addr,r),Dt(i,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||vd,r[o])}function d2(n,e,t){let i=this.cache,s=e.length,r=Zc(t,s);Lt(i,r)||(n.uniform1iv(this.addr,r),Dt(i,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||yd,r[o])}function p2(n,e,t){let i=this.cache,s=e.length,r=Zc(t,s);Lt(i,r)||(n.uniform1iv(this.addr,r),Dt(i,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||xd,r[o])}function m2(n){switch(n){case 5126:return Jv;case 35664:return Kv;case 35665:return jv;case 35666:return Qv;case 35674:return e2;case 35675:return t2;case 35676:return n2;case 5124:case 35670:return i2;case 35667:case 35671:return s2;case 35668:case 35672:return r2;case 35669:case 35673:return o2;case 5125:return a2;case 36294:return c2;case 36295:return l2;case 36296:return h2;case 35678:case 36198:case 36298:case 36306:case 35682:return u2;case 35679:case 36299:case 36307:return f2;case 35680:case 36300:case 36308:case 36293:return d2;case 36289:case 36303:case 36311:case 36292:return p2}}var vh=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Zv(t.type)}},yh=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=m2(t.type)}},Mh=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){let s=this.seq;for(let r=0,o=s.length;r!==o;++r){let a=s[r];a.setValue(e,t[a.id],i)}}},gh=/(\w+)(\])?(\[|\.)?/g;function id(n,e){n.seq.push(e),n.map[e.id]=e}function g2(n,e,t){let i=n.name,s=i.length;for(gh.lastIndex=0;;){let r=gh.exec(i),o=gh.lastIndex,a=r[1],c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){id(t,l===void 0?new vh(a,n,e):new yh(a,n,e));break}else{let f=t.map[a];f===void 0&&(f=new Mh(a),id(t,f)),t=f}}}var br=class{constructor(e,t){this.seq=[],this.map={};let i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){let a=e.getActiveUniform(t,o),c=e.getUniformLocation(t,a.name);g2(a,c,this)}let s=[],r=[];for(let o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,i,s){let r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){let s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,o=t.length;r!==o;++r){let a=t[r],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,t){let i=[];for(let s=0,r=e.length;s!==r;++s){let o=e[s];o.id in t&&i.push(o)}return i}};function sd(n,e,t){let i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}var _2=37297,x2=0;function v2(n,e){let t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){let a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}var rd=new Pe;function y2(n){ze._getMatrix(rd,ze.workingColorSpace,n);let e=`mat3( ${rd.elements.map(t=>t.toFixed(4))} )`;switch(ze.getTransfer(n)){case Jr:return[e,"LinearTransferOETF"];case Ze:return[e,"sRGBTransferOETF"];default:return Ee("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function od(n,e,t){let i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+v2(n.getShaderSource(e),a)}else return r}function M2(n,e){let t=y2(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}var b2={[$0]:"Linear",[W0]:"Reinhard",[X0]:"Cineon",[q0]:"ACESFilmic",[Z0]:"AgX",[J0]:"Neutral",[Y0]:"Custom"};function S2(n,e){let t=b2[e];return t===void 0?(Ee("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var $c=new D;function w2(){ze.getLuminanceCoefficients($c);let n=$c.x.toFixed(4),e=$c.y.toFixed(4),t=$c.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function E2(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ao).join(`
`)}function T2(n){let e=[];for(let t in n){let i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function A2(n,e){let t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(e,s),o=r.name,a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function Ao(n){return n!==""}function ad(n,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function cd(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var C2=/^[ \t]*#include +<([\w\d./]+)>/gm;function bh(n){return n.replace(C2,P2)}var R2=new Map;function P2(n,e){let t=Oe[e];if(t===void 0){let i=R2.get(e);if(i!==void 0)t=Oe[i],Ee('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return bh(t)}var I2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ld(n){return n.replace(I2,L2)}function L2(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function hd(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}var D2={[po]:"SHADOWMAP_TYPE_PCF",[xr]:"SHADOWMAP_TYPE_VSM"};function N2(n){return D2[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var U2={[ds]:"ENVMAP_TYPE_CUBE",[Vs]:"ENVMAP_TYPE_CUBE",[mo]:"ENVMAP_TYPE_CUBE_UV"};function F2(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":U2[n.envMapMode]||"ENVMAP_TYPE_CUBE"}var O2={[Vs]:"ENVMAP_MODE_REFRACTION"};function B2(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":O2[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}var z2={[H0]:"ENVMAP_BLENDING_MULTIPLY",[Rf]:"ENVMAP_BLENDING_MIX",[Pf]:"ENVMAP_BLENDING_ADD"};function k2(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":z2[n.combine]||"ENVMAP_BLENDING_NONE"}function V2(n){let e=n.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function G2(n,e,t,i){let s=n.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,c=N2(t),l=F2(t),h=B2(t),f=k2(t),u=V2(t),d=E2(t),g=T2(r),v=s.createProgram(),m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);let w=M+m+o,b=M+p+a,A=sd(s,s.VERTEX_SHADER,w),E=sd(s,s.FRAGMENT_SHADER,b);s.attachShader(v,A),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function P(C){if(n.debug.checkShaderErrors){let R=s.getProgramInfoLog(v)||"",k=s.getShaderInfoLog(A)||"",G=s.getShaderInfoLog(E)||"",N=R.trim(),B=k.trim(),H=G.trim(),j=!0,Q=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(j=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,A,E);else{let le=od(s,A,"vertex"),xe=od(s,E,"fragment");Te("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
${s?s+`
`:""}  return v;
}`}var qi=_t,Xi=Ct($e.m.fromXyz,jt),Wn=$e.m.fromXyz,$m=.206,mu=.03,km=(1+$m)/(1+mu),_u=.017453292519943295,oM=216/24389,Vm=24389/27,gu=Bt[0],Gl=Bt[1],Wm=Bt[2],aM=4*gu/(gu+15*Gl+3*Wm),cM=9*Gl/(gu+15*Gl+3*Wm),Br={js:{f:n=>Ts(n,"js"),decl:(n,e)=>`let ${n} = ${e};`,decl3:(n,e)=>`let ${n} = ${e};`,loop:(n,e)=>`for (let i = 0; i < ${n}; i++) {
${e}
...
fn wp_toe_inv(x: f32) -> f32 { return (x * x + ${n.k1} * x) / (${n.k3} * (x + ${n.k2})); }`}};function Xm(n){return{a0:n.f(qi[0]),a1:n.f(qi[3]),a2:n.f(qi[6]),s0:n.f(Xi[0]),s1:n.f(Xi[1]),s2:n.f(Xi[2]),s3:n.f(Xi[3]),s4:n.f(Xi[4]),s5:n.f(Xi[5]),s6:n.f(Xi[6]),s7:n.f(Xi[7]),s8:n.f(Xi[8]),k1:n.f($m),k2:n.f(mu),k3:n.f(km),k4k2k3:n.f(4*mu*km)}}function qm(n){return[n.decl("h",n.mod360(n.in(0))),n.decl("hr",`h * ${n.f(_u)}`),n.decl("ca",n.cos("hr")),n.decl("cb",n.sin("hr")),n.decl("kl",`${n.f(qi[1])} * ca + ${n.f(qi[2])} * cb`),n.decl("km",`${n.f(qi[4])} * ca + ${n.f(qi[5])} * cb`),n.decl("ks",`${n.f(qi[7])} * ca + ${n.f(qi[8])} * cb`)].join(`
  `)}function Ym(n){return[n.decl("clo","0.0"),n.decl("chi","0.05"),n.loop(10,`    if (wp_min3(wp_oklc_lin(1.0, chi, kl, km, ks)) <= 0.0) { break; }
  ...
  `)}function Zm(n){return[n.decl3("lin","wp_oklc_lin(L, C, kl, km, ks)"),n.ret3(`wp_srgb_encode(${n.gx("lin",0)})`,`wp_srgb_encode(${n.gx("lin",1)})`,`wp_srgb_encode(${n.gx("lin",2)})`)].join(`
  `)}function xu(n){return n.ret3("1.0","1.0","1.0")}function Go(n){return n.ret3("0.0","0.0","0.0")}function lM(n,e){let t=Br[n],i=`${As[n].srgb_encode}
${t.linFn(Xm(t))}`,s=`  ${t.decl("s",t.in(1))}
  ${t.decl("vv",t.in(2))}
  if (vv <= 1e-9) { ${Go(t)} }
  ${qm(t)}
  ${Ym(t)}
  ...
  L = L * scale;
  C = C * scale;
  ${Zm(t)}`;return t.wrap(e,i,s)}var Gm=(n,e)=>({s:"0.11516993 + 1.0 / (7.4477897 + 4.1590124 * cb + ca * (-2.19557347 + 1.75198401 * cb + ca * (-2.13704948 - 10.02301043 * cb + ca * (-4.24894561 + 5.38770819 * cb + 4.69891013 * ca))))",t:"0.11239642 + 1.0 / (1.6132032 - 0.68124379 * cb + ca * (0.40370612 + 0.90148123 * cb + ca * (-0.27087943 + 0.6122399 * cb + ca * (0.00299215 - 0.45399568 * cb - 0.14661872 * ca))))"})[e];function hM(n,e){let t=Br[n],i=`${As[n].srgb_encode}
${t.linFn(Xm(t))}`,s=`  ${t.decl("s",t.in(1))}
  ${t.decl("ll",t.in(2))}
  if (ll >= 1.0 - 1e-9) { ${xu(t)} }
  if (ll <= 1e-9) { ${Go(t)} }
...
`),a=`  ${i.decl("s",i.in(1))}
  ...
  ${i.decl("sub2","sub1")}
  if (sub1 <= ${i.f(oM)}) { sub2 = ll / ${i.f(Vm)}; }
  ${i.decl("mx","1e30")}
${o}
  ${i.decl("C","mx / 100.0 * s")}
  ${i.decl("uu","C * chh")}
  ${i.decl("vv","C * sh")}
  ${i.decl("up",`uu / (13.0 * ll) + ${i.f(aM)}`)}
  ${i.decl("vp",`vv / (13.0 * ll) + ${i.f(cM)}`)}
  ${i.decl("Y",`ll / ${i.f(Vm)}`)}
...
fn wp_cam_unadapt(v: f32) -> f32 { let a = abs(v); let base = max(0.0, 27.13 * a / (400.0 - a)); return sign(v) * pow(base, ${(1/.42).toPrecision(17)}); }`};function Jm(n,e){return`${n.decl("alpha",`C / ${n.sqrt("J / 100.0")}`)}
  ...
  ${n.decl("lb",`${e.Mb[6]} * cr + ${e.Mb[7]} * cg + ${e.Mb[8]} * cbn`)}`}function uM(n,e){let t=Br[n],i=vu(t),s=`${As[n].srgb_decode}
${yu[n]}`,r=`  ${t.decl("dr",`wp_srgb_decode(${t.in(0)})`)}
  ...
  ${t.ret3("1.7 * J / (1.0 + 0.007 * J)",`Mp * ${t.cos("hr")}`,`Mp * ${t.sin("hr")}`)}`;return t.wrap(e,s,r)}function fM(n,e){let t=Br[n],i=vu(t),s=`${As[n].srgb_encode}
${yu[n]}`,r=`  ${t.decl("Jp",t.in(0))}
  ...
  ${t.decl("eHue",`0.25 * (${t.cos("hr + 2.0")} + 3.8)`)}
  ${Jm(t,i)}
  ${t.ret3("wp_srgb_encode(lr)","wp_srgb_encode(lg)","wp_srgb_encode(lb)")}`;return t.wrap(e,s,r)}function dM(n,e){let t=Br[n],i=vu(t),s=`${As[n].srgb_encode}
${yu[n]}`,r=(()=>{let a=Qn,c=st(mi.cat16);return[0,1,2].map(l=>t.f(c[3+l]/(a.rgbD[l]*a.fl)))})(),o=`  ${t.decl("tone",t.in(2))}
  if (tone <= 0.0) { ${Go(t)} }
  if (tone >= 100.0) { ${xu(t)} }
  ...
  ${t.decl("C",t.in(1))}
  ${t.decl("hr",`${t.mod360(t.in(0))} * ${t.f(_u)}`)}
  ${t.decl("eHue",`0.25 * (${t.cos("hr + 2.0")} + 3.8)`)}
  ${t.decl("jlo","0.0")}
  ${t.decl("jhi","400.0")}
  ...
  ${Jm(t,i)}
  ${t.ret3("wp_srgb_encode(lr)","wp_srgb_encode(lg)","wp_srgb_encode(lb)")}`;return t.wrap(e,s,o)}var pM={"okhsv|srgb":lM,"okhsl|srgb":hM,"hsluv|srgb":(n,e)=>Hm(n,e,!1),"hpluv|srgb":(n,e)=>Hm(n,e,!0),"srgb|cam16-ucs":uM,"cam16-ucs|srgb":fM,"hct|srgb":dM};function Km(n,e,t,i){let s=pM[`${e}|${t}`];return s?s(n,i):null}function Qm(n,e){let t=Wi[n],i=Wi[e];if(!t)throw new Error(`codegen: unsupported space "${n}" (have: ${Object.keys(Wi).join(", ")})`);if(!i)throw new Error(`codegen: unsupported space "${e}"`);return zm([...t.toXyzOps,...i.fromXyzOps])}function e1(n,e){return`wp_${n}_to_${e}`.replace(/-/g,"_")}function Ho(n,e,{name:t=e1(n,e)}={}){return Km("glsl",n,e,t)??pu(Qm(n,e),t,"glsl")}function mM(n){return`wp_gamut_map_oklch_to_${n}`.replace(/-/g,"_")}function gM(n,e,t){let i=e1("oklch",e),s=pu(Qm("oklch",e),i,n);return n==="js"?`${s}
...
}`}function _M(n){let e=Wi[n];if(!e||!e.fromXyzOps.some(t=>t.k==="mat3"))throw new Error(`codegen: gamut mapping needs an RGB gamut space (got "${n}")`)}function Mu(n,{name:e=mM(n)}={}){return _M(n),gM("glsl",n,e)}var xM={hsl:0,hwb:0,hsv:0,hsi:0,okhsl:0,okhsv:0,hct:0,hsluv:0,hpluv:0,lch:2,oklch:2,lchuv:2,jzczhz:2,"din99o-lch":2,cam16:2},vM=["shorter","longer","increasing","decreasing"];function jm(n,e){let i=`${(n==="glsl"||n==="wgsl"?(s,r)=>`mod(${s}, ${r})`:(s,r)=>`(((${s}) % ${r}) + ${r}) % ${r}`)("hb - ha + 360.0","360.0")}`;switch(e){case"shorter":return`float d0 = ${i}; float d = d0 > 180.0 ? d0 - 360.0 : d0;`;case"longer":return`float d0 = ${i}; float d = d0 == 0.0 ? 360.0 : (d0 < 180.0 ? d0 - 360.0 : d0);`;case"increasing":return`float d = ${i};`;case"decreasing":return`float d0 = ${i}; float d = d0 == 0.0 ? 0.0 : d0 - 360.0;`;default:throw new Error(`codegen: unknown hue method "${e}"`)}}function yM(n,e,t,i){let s=xM[e]??-1;if(!Wi[e]&&s===-1)throw new Error(`codegen: unsupported space "${e}"`);if(!vM.includes(t))throw new Error(`codegen: unknown hue method "${t}"`);let r=["x","y","z"],o=l=>`a.${r[l]} + t * (b.${r[l]} - a.${r[l]})`;if(n==="js"){let l=[];for(let h=0;h<3;h++)h===s?l.push(`  const ha = ((a[${h}] % 360) + 360) % 360;`,`  const hb = ((b[${h}] % 360) + 360) % 360;`,`  ${jm("js",t).replace(/float /g,"const ").replace(/const d0/,"const d0").replace("const d =","const d =")}`,`  out[${h}] = (((ha + t * d) % 360) + 360) % 360;`):l.push(`  out[${h}] = a[${h}] + t * (b[${h}] - a[${h}]);`);return`function ${i}(a, b, t, out = [0, 0, 0]) {
${l.join(`
`)}
  return out;
  ...
  v.${r[s]} = (ha + t * d) % 360.0;
  return v;
}`}function MM(n,e){return`wp_mix_${n}_${e}`.replace(/-/g,"_")}function t1(n,{hue:e="shorter",name:t=MM(n,e)}={}){return yM("glsl",n,e,t)}function Hl(n,e,t,i=24,s=0,r=Math.PI*2){let o=[];for(let a=0;a<=i;a++){let c=s+(r-s)*(a/i);o.push([n+t*Math.cos(c),e+t*Math.sin(c)])}return o}var Yi=(n,e,t,i,s,r=10)=>Hl(n,e,t,r,i*Math.PI/180,s*Math.PI/180),bM={w:{w:.84,strokes:[[[0,1],[.22,0],[.42,.75],[.62,0],[.84,1]]]},h:{w:.6,strokes:[[[0,1.5],[0,0]],[[0,.55],...Yi(.3,.55,.3,180,0),[.6,0]]]},i:{w:.06,strokes:[[[0,1],[0,0]],Hl(0,1.28,.045,10)],closed:[!1,!0]},t:{w:.6,strokes:[[[.3,1.45],[.3,.2],...Yi(.5,.2,.2,180,270)],[[0,1],[.6,1]]]},e:{w:.9,strokes:[[[.07,.55],[.83,.55],...Yi(.45,.5,.45,7,320,26)]]},p:{w:.85,strokes:[[[0,1],[0,-.5]],[[0,.78],...Yi(.38,.5,.45,128,-128),[0,.22]]]},o:{w:.9,strokes:[Hl(.45,.5,.45)],closed:[!0]},n:{w:.56,strokes:[[[0,1],[0,0]],[[0,.58],...Yi(.28,.58,.28,180,0),[.56,0]]]},B:{w:.85,strokes:[[[0,1.4],[0,0]],[[0,1.4],[.45,1.4],...Yi(.45,1.05,.35,90,-90),[0,.7],[.5,.7],...Yi(.5,.35,.35,90,-90),[0,0]]]},A:{w:.9,strokes:[[[0,0],[.45,1.4],[.9,0]],[[.2,.5],[.7,.5]]]},R:{w:.8,strokes:[[[0,1.4],[0,0]],[[0,1.4],[.4,1.4],...Yi(.4,1.05,.35,90,-90),[0,.7]],[[.3,.7],[.75,0]]]},O:{w:.95,strokes:[SM(.475,.7,.42,.7)],closed:[!0]},P:{w:.8,strokes:[[[0,1.4],[0,0]],[[0,1.4],[.4,1.4],...Yi(.4,1.05,.35,90,-90),[0,.7]]]},E:{w:.75,strokes:[[[.72,1.4],[0,1.4],[0,0],[.72,0]],[[0,.7],[.58,.7]]]},N:{w:.8,strokes:[[[0,0],[0,1.4],[.75,0],[.75,1.4]]]},L:{w:.72,strokes:[[[0,1.4],[0,0],[.68,0]]]},I:{w:.06,strokes:[[[0,1.4],[0,0]]]},V:{w:.9,strokes:[[[0,1.4],[.45,0],[.9,1.4]]]}};function SM(n,e,t,i,s=28){let r=[];for(let o=0;o<=s;o++){let a=Math.PI*2*o/s;r.push([n+t*Math.cos(a),e+i*Math.sin(a)])}return r}var n1={w:1.5,strokes:[[[-.7,1.55],[0,.7],[.7,1.55]],[[0,.66],[0,.08]],[[-.34,.04],[.34,.04]],Hl(.16,1.22,.1,14),[[.16,1.34],[.4,1.66]]],closed:[!1,!1,!1,!0,!1]};function wM(n,e=.05){if(n.length<3)return n;let t=[n[0]];for(let i=1;i<n.length-1;i++){let[s,r]=n[i-1],[o,a]=n[i],[c,l]=n[i+1],h=[s-o,r-a],f=[c-o,l-a],u=Math.hypot(...h),d=Math.hypot(...f),g=Math.min(e,u*.4,d*.4);if(g<1e-4){t.push(n[i]);continue}let v=[o+h[0]/u*g,a+h[1]/u*g],m=[o+f[0]/d*g,a+f[1]/d*g];for(let p=0;p<=1;p+=.25){let M=1-p;t.push([M*M*v[0]+2*M*p*o+p*p*m[0],M*M*v[1]+2*M*p*a+p*p*m[1]])}}return t.push(n[n.length-1]),t}function EM(n,{radius:e=.035,closed:t=!1}={}){let i=n.filter(([c,l],h)=>h===0||Math.hypot(c-n[h-1][0],l-n[h-1][1])>1e-4),r=(t?i:wM(i)).map(([c,l])=>new D(c,l,0));t&&r.pop();let o=new ls(r,t,"catmullrom",t?.5:0),a=Math.max(12,r.length*4);return new Bs(o,a,e,8,t)}function i1(n,{radius:e=.035,spacing:t=.32}={}){let i=[],s=0,r=typeof n=="string"?[...n].map(o=>bM[o]):n;for(let o of r){if(!o){s+=.5;continue}o.strokes.forEach((a,c)=>{let l=EM(a.map(([h,f])=>[h+s,f]),{radius:e,closed:o.closed?.[c]??!1});i.push(l)}),s+=o.w+t}return{geometries:i,width:Math.max(0,s-t)}}function Su(...n){let e=new Set,t=[];for(let i of n){let s=i.split(`
...
${Su(Ho("xyz-d65","oklch"),Mu("display-p3"),Mu("srgb"),Ho("srgb","display-p3"))}
  void main() {
...
`;function bu(n,e){let t=new _r({glslVersion:So,vertexShader:TM,fragmentShader:n,uniforms:e,depthTest:!1,depthWrite:!1}),i=new Fe(new en,t);i.frustumCulled=!1,i.geometry.setDrawRange(0,3);let r=new Fs;return r.add(i),{scene:r,mat:t}}function s1(n,e){return new qt(n,e,{type:wn,minFilter:At,magFilter:At,depthBuffer:!1,colorSpace:zn})}function wu(n,e,t,i){let s=new qt(e,t,{type:wn,samples:4,colorSpace:zn}),r=Math.max(1,e>>1),o=Math.max(1,t>>1),a=s1(r,o),c=s1(r,o),l=AM(),h=bu(CM,{tScene:{value:s.texture},uMode:i,uThreshold:{value:1.2}}),f=bu(RM,{tSrc:{value:null},uDir:{value:new we}}),u=bu(l,{tScene:{value:s.texture},tBloom:{value:c.texture},uMode:i,uP3:{value:0},uSrgbPreview:{value:0},uExposure:{value:1},uBloomAmt:{value:.7}}),d=new zs;function g(m,p){n.setRenderTarget(s),n.render(m,p),n.setRenderTarget(a),n.render(h.scene,d);for(let M=0;M<2;M++)f.mat.uniforms.tSrc.value=a.texture,f.mat.uniforms.uDir.value.set(1/r,0),n.setRenderTarget(c),n.render(f.scene,d),f.mat.uniforms.tSrc.value=c.texture,f.mat.uniforms.uDir.value.set(0,1/o),n.setRenderTarget(a),n.render(f.scene,d);u.mat.uniforms.tBloom.value=a.texture,n.setRenderTarget(null),n.render(u.scene,d)}function v(){s.dispose(),a.dispose(),c.dispose();for(let m of[h,f,u])m.mat.dispose()}return{render:g,output:u.mat,sceneRT:s,dispose:v,source:l}}var In=8,PM=`
  varying vec3 vPos;
  varying vec3 vNormal;
  varying vec2 vUv;
  void main() {
...
`}function Ln(n){return new D(n[0],n[1],n[2])}function $l(n,e){let t=n.slice(0,In).map(Ln);for(;t.length<In;)t.push(Ln(e));return t}function Qt(n,e,t=e,i={}){let{pairs:s}=n.derived,r=new It({vertexShader:PM,fragmentShader:IM,uniforms:{uPairA:{value:$l(s[e],[0,0,0])},uPairB:{value:$l(s[t],[0,0,0])},uNaiveLight:n.shared.uNaiveLight,uLightPos:n.shared.uLightPos,uIntensity:n.shared.uIntensity,uAlbedoA:{value:Ln(n.materialsSrgb[e])},uAlbedoB:{value:Ln(n.materialsSrgb[t])},uUvScale:{value:new we(...i.uvScale??[1,1])},uKind:{value:i.kind??0},uWetness:n.shared.uWetness,uMode:n.uMode}});return n.surfaceMats.push({mat:r,matA:e,matB:t}),r}function Tu(n){for(let e of n.tubeMats??[])e.uniforms.uXyz.value.set(...n.xyz),e.uniforms.uNaive.value.set(...n.naive);if(n.haloMat){let{bright:e,dark:t}=c1(n);n.haloMat.uniforms.uLchBright.value.set(...e),n.haloMat.uniforms.uLchDark.value.set(...t),n.haloMat.uniforms.uNaive.value.set(...n.naive.map(i=>i*.5))}}function Wl(n){let{pairs:e,lights:t}=n.derived;for(let{mat:i,matA:s,matB:r}of n.surfaceMats)i.uniforms.uPairA.value=$l(e[s],[0,0,0]),i.uniforms.uPairB.value=$l(e[r],[0,0,0]);t.forEach((i,s)=>{s<In&&n.shared.uNaiveLight.value[s].set(...i.naive)})}function UM(n,e,t){return new It({vertexShader:LM,fragmentShader:o1,uniforms:{uXyz:{value:Ln(e.xyz)},uNaive:{value:Ln(e.naive)},uPower:{value:t},uFlicker:e.flicker,uMode:n.uMode}})}function Au(n,e,t,i,{grad:s=0,flicker:r}={}){return new It({vertexShader:Eu,fragmentShader:a1,uniforms:{uXyz:{value:Ln(e)},uNaive:{value:Ln(t)},uPower:{value:i},uFlicker:r??{value:1},uGrad:{value:s},uMode:n.uMode}})}function c1(n){let e=$n(n.xyz.map(i=>i*.32),"xyz-d65","oklch"),t=[.045,Math.min(e[1]*.35,.04),e[2]];return{bright:e,dark:t}}function FM(n,e,t){let{bright:i,dark:s}=c1(e);return new It({vertexShader:Eu,fragmentShader:NM(),uniforms:{uLchBright:{value:Ln(i)},uLchDark:{value:Ln(s)},uNaive:{value:Ln(e.naive.map(r=>r*.5))},uPower:{value:t},uFlicker:e.flicker,uMode:n.uMode},transparent:!0,blending:ks,depthWrite:!1})}function r1(n,e,{scale:t,tubeR:i=.035,panelPad:s=.3,haloScale:r=2.6,power:o=14}){let a=new xn,{geometries:c,width:l}=i1(e.text,{radius:i/t}),h=UM(n,e,o);e.tubeMats=[h];let f=new xn;for(let m of c){let p=new Fe(m,h);p.userData.light=e,n.clickables.push(p),f.add(p)}f.scale.setScalar(t),f.position.set(-l/2*t,-.5*t,.1),a.add(f);let u=l*t+s*2,d=1.5*t+s*2,g=new Fe(new on(u,d,.06),Qt(n,"panel"));g.position.set(0,.25*t,.02),g.userData.light=e,n.clickables.push(g),a.add(g);let v=new Fe(new an(u*r,d*r),FM(n,e,.3));if(e.haloMat=v.material,v.position.set(0,.25*t,.075),a.add(v),e.facing==="front")a.position.set(e.pos[0],e.pos[1],e.pos[2]);else{let m=e.pos[0]<0?-1:1;a.rotation.y=m<0?Math.PI/2:-Math.PI/2,a.position.set(e.pos[0]*.97,e.pos[1],e.pos[2])}return a}function OM(n,e,t){let i=new xn,s=1,r=1.5,o=new Fe(new on(s+.16,r+.16,.1),Qt(n,"panel"));i.add(o);let a=2,c=3,l=s/a,h=r/c;e.paneMats=[];for(let u=0;u<c;u++)for(let d=0;d<a;d++){let g=t[(u*a+d)%t.length],v=Au(n,g.xyz,g.naive,1.1,{flicker:e.flicker});e.paneMats.push(v);let m=new Fe(new an(l-.05,h-.05),v);m.position.set((d+.5)*l-s/2,(u+.5)*h-r/2,.06),i.add(m)}let f=e.pos[0]<0?-1:1;return i.rotation.y=f<0?Math.PI/2:-Math.PI/2,i.position.set(e.pos[0]*.97,e.pos[1],e.pos[2]),i}function BM(n,e){let t=new xn,i=Qt(n,"metal"),s=new Fe(new Ai(.05,.07,4.7,10),i);s.position.set(2.45,2.35,e.pos[2]),t.add(s);let r=new Fe(new Ai(.04,.04,1.3,8),i);r.rotation.z=Math.PI/2,r.position.set(1.85,4.66,e.pos[2]),t.add(r);let o=new Fe(new gr(.24,.22,12),i);o.position.set(e.pos[0],e.pos[1]+.16,e.pos[2]),t.add(o);let a=new Fe(new lo(.13,16,12),Au(n,e.xyz,e.naive,9,{flicker:e.flicker}));e.headMat=a.material,a.position.set(...e.pos),t.add(a);let c=new Fe(new gr(.5,3.4,24,1,!0),new It({vertexShader:Eu,fragmentShader:DM,uniforms:{uXyz:{value:Ln(e.xyz)},uNaive:{value:Ln(e.naive)},uPower:{value:.03},uFlicker:e.flicker,uMode:n.uMode},transparent:!0,blending:ks,depthWrite:!1,side:Mn}));return c.position.set(e.pos[0],e.pos[1]-1.78,e.pos[2]),t.add(c),t}function zM(n,e){let t=new xn;for(let i of e)i.updateMatrixWorld(!0),i.traverse(s=>{if(!s.isMesh)return;let r=s.material.fragmentShader===o1,o=s.material.fragmentShader===a1;if(!r&&!o)return;let a=s.material.clone();a.uniforms.uFlicker=s.material.uniforms.uFlicker,a.uniforms.uMode=n.uMode,a.uniforms.uPower={value:s.material.uniforms.uPower.value},n.reflectionMats.push({m:a,src:s.material}),a.transparent=!0,a.blending=ks,a.depthWrite=!1,a.side=Mn;let c=new Fe(s.geometry,a);c.applyMatrix4(s.matrixWorld),c.applyMatrix4(new at().makeScale(1,-1,1)),c.applyMatrix4(new at().makeScale(1,1.18,1)),t.add(c)});return t}function l1(n){let e=n.shared.uWetness.value;for(let{m:t,src:i}of n.reflectionMats)t.uniforms.uPower.value=i.uniforms.uPower.value*.38*e,t.uniforms.uXyz=i.uniforms.uXyz,t.uniforms.uNaive=i.uniforms.uNaive}function h1(n){let e=new Fs,{lights:t,windowPanes:i,sky:s,skyNaive:r}=n.derived,o=Object.fromEntries(t.map(x=>[x.name,x])),a=new Fe(new an(7.2,26,1,1),Qt(n,"asphalt","asphaltWet",{kind:2,uvScale:[6,22]}));a.rotation.x=-Math.PI/2,a.position.set(0,0,-5),a.material.depthWrite=!1,a.renderOrder=-2,e.add(a);let c={kind:1,uvScale:[104,84]},l=new Fe(new an(21,7),Qt(n,"brick","mortar",{kind:1,uvScale:[84,84]}));l.rotation.y=Math.PI/2,l.position.set(-2.8,3.5,-2.5),e.add(l);let h=new Fe(new an(26,7),Qt(n,"brick","mortar",c));h.rotation.y=-Math.PI/2,h.position.set(2.8,3.5,-5),e.add(h);let f=new Fe(new an(4.1,5.2),Qt(n,"brick","mortar",{kind:1,uvScale:[16,62]}));f.position.set(-.75,2.6,-13),e.add(f);let u=new Fe(new an(1.7,5.2),Qt(n,"concrete","concrete",{kind:1,uvScale:[6,38]}));u.position.set(1.95,2.6,-18),e.add(u);let d=new Fe(new an(9,7),Au(n,s,r,3,{grad:1}));d.position.set(0,8.4,-18.4),e.add(d);for(let x of[-2.65,2.65]){let T=new Fe(new on(.3,.16,26),Qt(n,"concrete"));T.position.set(x,.08,-5),e.add(T)}let g=[],v=(x,T)=>{let I=r1(n,x,T);g.push(I),e.add(I)};o.whitepoint.text="whitepoint";let m=r1(n,o.whitepoint,{scale:.45,power:5.5});g.push(m),e.add(m);for(let x of[-1,1]){let T=new Fe(new Ai(.012,.012,2.6,6),Qt(n,"metal"));T.position.set(.7+x*2,5.45,-5.2),T.rotation.z=x*.45,e.add(T)}o.bar.text="BAR",v(o.bar,{scale:.42,tubeR:.04,power:4.5}),o.open.text="OPEN",v(o.open,{scale:.3,power:4.5}),o.cocktail.text=[n1],v(o.cocktail,{scale:.62,power:4.5}),o.live.text="LIVE",v(o.live,{scale:.34,power:4.2});let p=OM(n,o.window,i);e.add(p);let M=BM(n,o.street);e.add(M);let w=new Fe(new on(.06,2.2,1),Qt(n,"door"));w.position.set(-2.76,1.1,-2.2),e.add(w);let b=new Fe(new on(.5,.14,1.2),Qt(n,"concrete"));b.position.set(-2.6,.07,-2.2),e.add(b);let A=new Fe(new on(.95,1.15,1.9),Qt(n,"door"));A.position.set(-2.25,.58,-7.6),e.add(A);let E=new Fe(new on(1,.08,1.95),Qt(n,"metal"));E.position.set(-2.27,1.18,-7.6),E.rotation.z=.07,e.add(E);for(let[x,T]of[[-6.2,6.8],[-11.5,6.8]]){let I=new Fe(new Ai(.05,.05,T,8),Qt(n,"metal"));I.position.set(2.74,T/2,x),e.add(I)}let P=Qt(n,"metal");for(let[x,T,I]of[[-1.1,6,.5],[-6.6,5.7,.65],[-10.9,6.2,.45]]){let C=[new D(-2.8,T,x),new D(0,T-I,x+.25),new D(2.8,T+.15,x)],R=new Fe(new Bs(new ls(C),24,.014,5),P);e.add(R)}return e.add(zM(n,[...g,p,M])),e}ze.enabled=!1;var VM=[{name:"whitepoint",gas:"neon",pos:[.7,4.15,-5.2],facing:"front",nudge:[0,-.6,.7],intensity:1.6},{name:"bar",gas:"helium",pos:[-2.05,3.05,-1.6],facing:"front",nudge:[0,0,.5],intensity:1},{name:"open",gas:"mercury",pos:[2,2.75,-7.5],facing:"front",nudge:[0,0,.5],intensity:.9},{name:"cocktail",gas:"xenon",pos:[-1.75,3.15,-12.9],facing:"front",nudge:[0,0,.6],intensity:.85},{name:"live",gas:"hydrogen",pos:[-.35,2.35,-12.9],facing:"front",nudge:[0,0,.6],intensity:.7},{name:"window",window:["#1a3f8f","#8f1a2e","#1f6e52","#b1741f"],pos:[-2.8,2.6,-10.5],intensity:.6},{name:"street",gas:"sodium-lamp",pos:[1.25,4.55,4.6],intensity:2.2}],GM=n=>{if(n.nudge)return n.pos.map((t,i)=>t+n.nudge[i]);let e=Math.abs(n.pos[0])>2.5?-Math.sign(n.pos[0])*.5:0;return[n.pos[0]+e,n.pos[1],n.pos[2]]},kr=document.getElementById("alley"),$o=kr.getContext("webgl2",{antialias:!1,alpha:!1,preserveDrawingBuffer:!0});if("drawingBufferColorSpace"in $o)try{$o.drawingBufferColorSpace="display-p3"}catch{}var Kl=$o.drawingBufferColorSpace==="display-p3",Wo=new qc({canvas:kr,context:$o,antialias:!1});Wo.toneMapping=bn;var Dn=Rm(VM);Dn.lights.forEach(n=>{n.flicker={value:1}});var Cu=(n,e)=>Array.from({length:n},(t,i)=>e(i)),E1={uLightPos:{value:Cu(In,n=>new D(...Dn.lights[n]?GM(Dn.lights[n]):[0,-99,0]))},uIntensity:{value:Cu(In,n=>Dn.lights[n]?.intensity??0)},uNaiveLight:{value:Cu(In,n=>new D(...Dn.lights[n]?.naive??[0,0,0]))},uWetness:{value:.85}},jl={value:0},Zs={derived:Dn,materialsSrgb:kl,shared:E1,uMode:jl,surfaceMats:[],reflectionMats:[],clickables:[]};Dn.lights.forEach((n,e)=>{n.index=e});var HM=h1(Zs),zr=new Xt(54,1,.1,80);function T1(){let n=kr.clientWidth,e=Math.round(n*.58),t=Math.min(window.devicePixelRatio||1,2);return Wo.setSize(n,e,!1),Wo.setPixelRatio(t),zr.aspect=n/e,zr.updateProjectionMatrix(),[Math.round(n*t),Math.round(e*t)]}var[Yl,Zl]=T1(),Zi=wu(Wo,Yl,Zl,jl);Zi.output.uniforms.uP3.value=Kl?1:0;window.addEventListener("resize",()=>{let[n,e]=T1();(n!==Yl||e!==Zl)&&([Yl,Zl]=[n,e],Zi.dispose?.(),Zi=wu(Wo,Yl,Zl,jl),Zi.output.uniforms.uP3.value=Kl?1:0,Zi.output.uniforms.uSrgbPreview.value=Ut.srgbPreview?1:0)});var Ut={naive:!1,sodiumOnly:!1,srgbPreview:!1,kT:.5},A1=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches??!1,Xo=()=>{A1&&n0(10)},d1=document.getElementById("shader-src");d1&&(d1.textContent=Zi.source);var p1=document.getElementById("mode");p1?.addEventListener("change",()=>{Ut.naive=p1.checked,jl.value=Ut.naive?1:0,document.body.dataset.mode=Ut.naive?"naive":"whitepoint",Xo()});var m1=document.getElementById("gamut-badge");m1&&(m1.textContent=Kl?"display-p3 output \u2014 your display shows the wide-gamut reds":"sRGB display \u2014 the emitted cusp mapper is doing the fallback live");var g1=document.getElementById("derived");function Ql(){g1&&(g1.textContent=Dn.lights.map(n=>{let[e,t,i]=n.xyz,s=e/(e+t+i),r=t/(e+t+i),o=n.window?"2700 K Planck \xD7 stained glass":n.gas==="sodium-lamp"?"Na D doublet":`${n.gas} (NIST lines)`;return`${n.name.padEnd(10)} ${o.padEnd(28)} xy ${s.toFixed(3)} ${r.toFixed(3)}   naive #${n.naive.map(a=>Math.round(a*255).toString(16).padStart(2,"0")).join("")}`}).join(`
`))}Ql();var e0=Dn.lights.filter(n=>n.gas&&n.gas!=="sodium-lamp"),ni=e0[0],_1=document.getElementById("sign-tabs"),x1=document.getElementById("gas-row"),v1=document.getElementById("gas-info");function y1(n,e,t,i=""){let s=document.createElement("button");return s.className=`chip ${e?"on":""} ${i}`,s.textContent=n,s.setAttribute("aria-pressed",String(e)),s.addEventListener("click",t),s}function t0(){!_1||!x1||(_1.replaceChildren(...e0.map(n=>y1(n.name,n===ni,()=>{ni=n,t0()}))),x1.replaceChildren(...Object.keys(zl).map(n=>y1(n,ni.gas===n,()=>$M(ni,n)))),v1&&(v1.textContent=zl[ni.gas]??""),C1())}function $M(n,e){Vl(Dn,n.index,e,Ut.kT),Wl(Zs),Tu(n),Ql(),t0(),Xo()}var Xl=document.getElementById("spd"),M1=document.getElementById("spd-caption");function C1(){if(!Xl||!ni)return;let n=Xl.getContext("2d"),e=Xl.width,t=Xl.height;n.clearRect(0,0,e,t);let i=380,s=780,r=o=>(o-i)/(s-i)*(e-20)+10;n.fillStyle="rgba(154,160,174,0.6)",n.font="10px ui-monospace, monospace";for(let o=400;o<=750;o+=50)n.fillRect(r(o),t-14,1,4),n.fillText(`${o}`,r(o)-9,t-2);for(let[o,a]of Cm(ni.gas,Ut.kT)){let c=Math.sqrt(a)*(t-26);n.strokeStyle=Am(o),n.globalAlpha=.35+.65*Math.sqrt(a),n.lineWidth=a>.5?2:1,n.beginPath(),n.moveTo(r(o),t-16),n.lineTo(r(o),t-16-c),n.stroke()}if(n.globalAlpha=1,M1){let[o,a,c]=ni.xyz,l=o/(o+a+c),h=a/(o+a+c);M1.textContent=`${ni.name} \u2014 ${ni.gas} emission lines (NIST ASD), powers \u221D (g\xB7A/\u03BB)\xB7exp(\u2212E/kT) at kT = ${Ut.kT.toFixed(2)} eV \u2192 xy ${l.toFixed(3)} ${h.toFixed(3)}`}}var b1=document.getElementById("kt"),Jl=document.getElementById("kt-readout");function WM(n){Ut.kT=n,Jl&&(Jl.textContent=`${n.toFixed(2)} eV`);for(let e of e0)Vl(Dn,e.index,e.gas,n),Tu(e);Wl(Zs),Ql(),C1(),Xo()}b1?.addEventListener("input",()=>WM(parseFloat(b1.value)));Jl&&(Jl.textContent=`${Ut.kT.toFixed(2)} eV`);t0();var S1=new fo;kr.addEventListener("click",n=>{let e=kr.getBoundingClientRect(),t=new we((n.clientX-e.left)/e.width*2-1,-((n.clientY-e.top)/e.height)*2+1);S1.setFromCamera(t,zr);let i=S1.intersectObjects(Zs.clickables,!1)[0];i?.object.userData.light&&e0.includes(i.object.userData.light)&&(ni=i.object.userData.light,t0())});var Ru=document.getElementById("kill");Ru?.addEventListener("click",()=>{Ut.sodiumOnly=!Ut.sodiumOnly,Ru.classList.toggle("on",Ut.sodiumOnly),Ru.textContent=Ut.sodiumOnly?"relight the neon":"kill the neon",Xo()});var ql=document.getElementById("srgb-preview");ql&&Kl&&(ql.hidden=!1,ql.addEventListener("click",()=>{Ut.srgbPreview=!Ut.srgbPreview,ql.classList.toggle("on",Ut.srgbPreview),Zi.output.uniforms.uSrgbPreview.value=Ut.srgbPreview?1:0,Xo()}));var XM=n=>n-Math.floor(n),w1=n=>XM(Math.sin(n*12.9898)*43758.5453);function qM(n,e,t){let i=1+.022*Math.sin(e*120*Math.PI+n*1.7),s=Math.floor(e*6.3)+n*197,a=w1(s)<(t?.14:.035)?.3+.55*w1(s+.5):1;return i*a}function n0(n){zr.position.set(.26*Math.sin(n*.07),1.7+.05*Math.sin(n*.11),7.4),zr.lookAt(.1*Math.sin(n*.05),2.15,-6),Dn.lights.forEach((e,t)=>{let i=e.gas==="sodium-lamp",s=Ut.sodiumOnly&&!i?0:1,r=qM(t,n,e.name==="live")*s;e.flicker.value=r,E1.uIntensity.value[t]=e.intensity*r}),l1(Zs),Zi.render(HM,zr)}var YM=performance.now();function R1(){n0((performance.now()-YM)/1e3),requestAnimationFrame(R1)}A1?n0(10):requestAnimationFrame(R1);window.__alley={ctx:Zs,swapGas:(n,e)=>{Vl(Dn,n,e),Wl(Zs),Ql()},state:Ut,GASES:zl,tick:n0,gl:$o,post:()=>Zi};location.search.includes("selftest")&&Promise.resolve().then(()=>(f1(),u1)).then(n=>n.selftest(window.__alley,kr));
